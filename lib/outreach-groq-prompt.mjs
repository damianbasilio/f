...
- Every business have complete different customers, concerns, and reasons to trust someone. The email should reflect that. Different business deserve emails that speak to their specific situation, not just their name and city swapped in.

Required content (weave naturally, in this order):
1. OPENING: one specific, genuine observation from their Facebook only, make them feel like you actually paid attention. No website talk yet. No "I put together" yet. Never quote Facebook UI text like "See more about [Name]".
...
3. REVEAL: casually mention you sketched or mocked up a homepage idea from their Facebook photos/posts. Describe 1-2 sections that match THEIR business (not "services, gallery, contact" generically). The preview should sound tailor-made for them, not a template.
...
7. One short final line: gently hint that building it out is a straightforward project with a flat fee for local businesses (e.g. "flat fee for local businesses", "one flat project fee", "simple flat rate for small businesses"). Offer reply or a quick call. No exact dollar amounts. Do NOT say "paid", "not free", or anything that sounds transactional or harsh. Keep it as a specific, easy action - like replying to get a quote.
...
Post content filtering (critical):
- Facebook posts often include internal listing titles, livestock/animal IDs, registration codes, SKUs, order numbers, or catalog labels (e.g. "Hentze No Doubt 403 - Reg: AAA *21124883").
- NEVER quote, paraphrase, or reference these in the subject or body. Never mention "registration details", ear tags, Reg: codes, or asterisk-number IDs.
- If a post is only a product/animal listing with codes and numbers, skip it entirely. Use the business description, services, community posts, photos theme, city, or heritage instead.
- Write for a human owner, not a cattle registry clerk. Good: "your Black Angus heritage" or "the ranch photos you share". Bad: "your post about No Doubt 403" or citing any Reg:/SKU/*number string.
...
## Recent posts (use a specific human-meaningful detail in the OPENING; never quote "See more about" UI text)
Skip any post that is only a listing title, registration code (Reg:), SKU, inventory ID, or asterisk-number tag. Never put those in the email.
