...
function normalizeCategory(cat) {
  ...
  if (/tow|recovery|plumb|electric|hvac|roof|contract|construction|repair|auto/.test(c)) return "trades";
...
const PROFILES = {
  ...
  pet: {
    ...
    fontBody: "Nunito",
    googleFonts: "Fraunces:opsz,wght@9..144,600;700&family=Nunito:wght@400;600;700",
