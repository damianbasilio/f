# Design QA — sheryl-s-candy-apple-creations-jacksonville
...
- WARN: 25 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 25 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
