// Form Submission Interaction
        ...
        form.addEventListener('submit', (e) => {
            e.preventDefault();
            form.classList.add('opacity-0', 'pointer-events-none', 'transition-all', 'duration-500');
            setTimeout(() => {
        ...
        mobileBtn.addEventListener('click', () => {
            alert('Mobile navigation is stylized as a full-screen editorial spread in development.');
        });
