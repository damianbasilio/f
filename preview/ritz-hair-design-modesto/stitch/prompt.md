# Stitch prompt — Ritz Hair Design (ritz-hair-design-modesto)

Use with: `npm run stitch:prompt -- ritz-hair-design-modesto` then `npm run stitch:build -- ritz-hair-design-modesto`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Ritz Hair Design**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/The-Ritz-Hair-Salon-100063684633043/
**Business:** Ritz Hair Design
**Category:** Salon / spa / personal care
**Location:** 2001 McHenry Avenue, Modesto, CA 95350
**Phone:** (209) 571-3377
**Email:** johnsonyoukana@att.net
**Review score:** 4.6
**Page description:** The Ritz Hair Salon, Modesto. 698 likes · 243 were here. Haircut, Hair Color/Highlights, Wax, Hair or Eyelash extensions. 209-571-3377
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 2001 McHenry Ave, Suite K, Modesto, CA, United States, 95350

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
The Ritz Hair Salon, Modesto. 698 likes · 243 were here. Haircut, Hair Color/Highlights, Wax, Hair or Eyelash extensions. 209-571-3377
Hours: Closed now
Address: 2001 McHenry Ave, Suite K, Modesto, CA, United States, 95350
Phone: 209-571-3377
Email: johnsonyoukana@att.net
...
1. We're hiring! Apply now
2. Haircut, Hair Color/Highlights, Wax, Hair or Eyelash extensions. 209-571-3377
...
Reading this as: a first homepage for Ritz Hair Design in Modesto (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **boutique-window** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Ritz Hair Design** only — it must not resemble other local-business sites or AI templates.
...
**Ritz Hair Design** is a Salon / spa / personal care in Modesto.
...
- **H1 (adapt closely):** Ritz Hair Design — serving Modesto
- **Subhead:** The Ritz Hair Salon, Modesto. 698 likes · 243 were here. Haircut, Hair Color/Highlights…
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Modesto), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Ritz Hair Design — serving Modesto, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Ritz Hair Design"
