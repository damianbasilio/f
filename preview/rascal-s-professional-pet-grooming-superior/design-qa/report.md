# Design QA — rascal-s-professional-pet-grooming-superior
...
- WARN: 20 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 20 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
