// Micro-interaction for the lens cursor
        const lens = document.getElementById('lens-cursor');
        document.addEventListener('mousemove', (e) => {
            lens.style.transform = `translate(${e.clientX - 16}px, ${e.clientY - 16}px)`;
        });
        ...
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                btn.innerText = 'Preview only';
                btn.classList.add('bg-secondary', 'border-secondary', 'text-on-primary');
                form.reset();
                setTimeout(() => {
                    btn.innerText = originalText;
                    btn.classList.remove('bg-secondary', 'border-secondary', 'text-on-primary');
                    btn.disabled = false;
                }, 3000);
            }, 1500);
        });
