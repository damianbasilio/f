// Micro-interaction for smooth nav scrolling
        ...
        // Simple scroll reveal for the thread
        window.addEventListener('scroll', () => {
            const thread = document.querySelector('.infinite-thread');
            if (thread) {
                const scrollPos = window.scrollY;
                thread.style.strokeDashoffset = 1000 - (scrollPos / 2);
            }
        });
