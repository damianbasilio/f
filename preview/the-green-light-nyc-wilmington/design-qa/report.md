# Design QA — the-green-light-nyc-wilmington
...
- WARN: 31 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 31 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
