# Stitch prompt — The Dough Truck (the-dough-truck-oshkosh)

Use with: `npm run stitch:prompt -- the-dough-truck-oshkosh` then `npm run stitch:build -- the-dough-truck-oshkosh`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **The Dough Truck**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/profile.php?id=61575972155061
**Business:** The Dough Truck
**Category:** Restaurant / food service
**Location:** 606 Franklin Street, Oshkosh, WI 54901
**Phone:** (920) 379-2640
**Email:** thedoughtruck365@gmail.com
**Review score:** 5
**Page description:** This is NOT your local midwest pizza spot. I'm spinning Neapolitan style pizzas at +800° out of a fully customized box truck and thats it, aside from an occasional sandwich or maybe some fresh bread, who knows. Special events focused, message us today!
...
This is NOT your local midwest pizza spot. I'm spinning Neapolitan style pizzas at +800° out of a fully customized box truck and thats it, aside from an occasional sandwich or maybe some fresh bread, who knows. Special events focused, message us today!
Phone: 265.663 7265
Email: thedoughtruck365@gmail.com

Recent posts from their Facebook page:
1. Only one chance to catch us in the wild this week! Join us Wednesday night @area509appleton from 5-8pm! LONG LIVE GOOD PIZZA #foodtruck #pizza #foodie #Appleton #longlivegoodpizza
2. This is NOT your local midwest pizza spot. I'm spinning Neapolitan style pizzas at +800° out of a fully customized box truck and thats it, aside from an occasional sandwich or maybe some fresh bread, who knows. Special events focused, message us today!
3. Oshkosh, WI, United States, Wisconsin
4. Let's Go (feat. Big D & Twista)
5. The Dough Truck is in Appleton, WI, United States.
6. It'll be available to watch on The Dough Truck's profile shortly.
...
Reading this as: a first homepage for The Dough Truck in Oshkosh (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **bold-type-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **The Dough Truck** only — it must not resemble other local-business sites or AI templates.
...
**The Dough Truck** is a Restaurant / food service in Oshkosh.
...
**Hero direction:**
- **H1 (adapt closely):** The Dough Truck — Oshkosh's local favorite
- **Subhead:** This is NOT your local midwest pizza spot. I'm spinning Neapolitan style pizzas at +800…
...
- Special events focused, message us today
- Daily specials
- Catering & events
- Dine-in & takeout
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (Oshkosh), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — The Dough Truck — Oshkosh's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with The Dough Truck"
