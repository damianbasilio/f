# Stitch prompt — Fresh Finish Mobile Detail (fresh-finish-mobile-detail-gastonia)

Use with: `npm run stitch:prompt -- fresh-finish-mobile-detail-gastonia` then `npm run stitch:build -- fresh-finish-mobile-detail-gastonia`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Fresh Finish Mobile Detail**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Fresh-Finish-Auto-Spa-61574194392800/
**Business:** Fresh Finish Mobile Detail
**Category:** Local business
**Location:** Gastonia, Gastonia, United States
**Phone:** (704) 772-6396
**Email:** freshfinishwash25@gmail.com
**Review score:** 5
**Page description:** Fresh Finish Auto Spa , Gastonia. 294 likes · 1 talking about this. Fresh Finish Auto Spa is a mobile detailing business. come sparkle with  Fresh Finish.
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** Gastonia, NC, United States, 28052-1998

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Fresh Finish Auto Spa , Gastonia. 294 likes · 1 talking about this. Fresh Finish Auto Spa is a mobile detailing business. come sparkle with  Fresh Finish.
Hours: Closed now
Address: Gastonia, NC, United States, 28052-1998
Phone: 980-522-4831
Email: freshfinishwash25@gmail.com
...
1. Call or message to book with Fresh Finish Auto Spa. Great deal till the end of may.
2. Fresh Finish Auto Spa is a mobile detailing business. come sparkle with Fresh Finish.
3. Gastonia, NC, United States, North Carolina
4. By using Meta AI, you agree to the AI terms. Your interactions with AIs will be used to improve AI at Meta.
5. Fresh Finish Auto Spa 's Photo
...
Reading this as: a first homepage for Fresh Finish Mobile Detail in Gastonia (Local business), Professional, welcoming, community-rooted tone, **magazine-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Fresh Finish Mobile Detail** only — it must not resemble other local-business sites or AI templates.
...
**Fresh Finish Mobile Detail** is a Local business in Gastonia.
...
**Hero direction:**
- **H1 (adapt closely):** Fresh Finish Mobile Detail — serving Gastonia
- **Subhead:** Fresh Finish Auto Spa , Gastonia. 294 likes · 1 talking about this. Fresh Finish Auto S…
...
2. **Hero** — Fresh Finish Mobile Detail — serving Gastonia, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Fresh Finish Mobile Detail"
