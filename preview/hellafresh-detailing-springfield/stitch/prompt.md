# Stitch prompt — HellaFresh Detailing (hellafresh-detailing-springfield)

Use with: `npm run stitch:prompt -- hellafresh-detailing-springfield` then `npm run stitch:build -- hellafresh-detailing-springfield`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **HellaFresh Detailing**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/people/HellaFresh-Detailing/61577779058748/
**Business:** HellaFresh Detailing
**Category:** Local business
**Location:** 2214 Wrenwood Road, Springfield, OH 45505
**Phone:** (937) 408-3199
**Email:** detailedbyl@gmail.com
**Review score:** 5
**Page description:** As detailers when did we start treating each other like competition? I personally don’t have the energy to argue or go back and forth in comments. I don’t care how much you charge, what tools you use, or how you structure your business. At the end of the day, we all run things differently. What matters is pushing the craft forward. If it works for you and your customers are happy, that’s what counts. I’m not in the business of competing with other detailers. I’m in the business of completing the job the right way. If you’re building, learning, and serving your customers with pride, you’ve got my support.
...
As detailers when did we start treating each other like competition? I personally don’t have the energy to argue or go back and forth in comments. I don’t care how much you charge, what tools you use, or how you structure your business. At the end of the day, we all run things differently. What matters is pushing the craft forward. If it works for you and your customers are happy, that’s what counts. I’m not in the business of competing with other detailers. I’m in the business of completing the job the right way. If you’re building, learning, and serving your customers with pride, you’ve got my support.
Phone: 265.663 7265
Email: detailedbyl@gmail.com

Recent posts from their Facebook page:
1. As detailers when did we start treating each other like competition? I personally don’t have the energy to argue or go back and forth in comments. I don’t care how much you charge, what tools you use, or how you structure your business. At the end of the day, we all run things differently. What matters is pushing the craft forward. If it works for you and your customers are happy, that’s what counts. I’m not in the business of competing with other detailers. I’m in the business of completing the job the right way. If you’re building, learning, and serving your customers with pride, you’ve got my support.
2. Auto Detailing Personal, Show, and Commercial. Premium results, worth your precious cash. Servicing Springfield, Ohio 📍

**Recent post captions (2 — echo their voice in headlines; skip registry/SKU/listing lines):**
1. "As detailers when did we start treating each other like competition? I personally don’t have the energy to argue or go back and forth in comments. I don’t care how much you charge, what tools you use, or how you structure your business. At the end of the day, we all run things differently. What matters is pushing the craft forward. If it works for you and your customers are happy, that’s what coun…"
2. "Auto Detailing Personal, Show, and Commercial. Premium results, worth your precious cash. Servicing Springfield, Ohio 📍"
...
Reading this as: a first homepage for HellaFresh Detailing in Springfield (Local business), Professional, welcoming, community-rooted tone, **cardless-flow** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **HellaFresh Detailing** only — it must not resemble other local-business sites or AI templates.
...
**HellaFresh Detailing** is a Local business in Springfield.
...
- **H1 (adapt closely):** HellaFresh Detailing — serving Springfield
- **Subhead:** As detailers when did we start treating each other like competition? I personally don’t…
...
2. **Hero** — HellaFresh Detailing — serving Springfield, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with HellaFresh Detailing"
