// Smooth scroll implementation
        ...
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                ...
                status.querySelector('p').innerText = 'Efcharistó! Your message has been sent successfully.';
                status.querySelector('p').classList.add('bg-tertiary-fixed', 'text-on-tertiary-fixed-variant');
                form.reset();
