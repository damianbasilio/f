# Stitch prompt — Ole Glory Barbershop (ole-glory-barbershop-nashville)

Use with: `npm run stitch:prompt -- ole-glory-barbershop-nashville` then `npm run stitch:build -- ole-glory-barbershop-nashville`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Ole Glory Barbershop**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Ole-Glory-Barbershop-100091055371754/
**Business:** Ole Glory Barbershop
**Category:** Restaurant / food service
**Location:** 210 25th Avenue North, Nashville, TN 37203
**Phone:** (615) 257-7147
**Email:** Emily@oleglorynashville.net
**Review score:** 4.9
**Page description:** When's the last time you've truly felt like you could check out? With the works package, you can fully check out and know that you are in great hands here at Ole Glory Barbershop. Come see what all the chatter is about! #barbershop #NasvilleBarber
**Hours:** Closed now
...
When's the last time you've truly felt like you could check out? With the works package, you can fully check out and know that you are in great hands here at Ole Glory Barbershop. Come see what all the chatter is about! #barbershop #NasvilleBarber
Hours: Closed now
Phone: 615-257-7147
Email: Emily@oleglorynashville.net

Recent posts from their Facebook page:
1. When's the last time you've truly felt like you could check out? With the works package, you can fully check out and know that you are in great hands here at Ole Glory Barbershop. Come see what all the chatter is about! #barbershop #NasvilleBarber
2. When you come to Ole Glory Barbershop it's an experience, not just a haircut.
3. Ole Glory Barbershop is at Ole Glory Barbershop.
4. It'll be available to watch on Ole Glory Barbershop's profile shortly.
...
Reading this as: a first homepage for Ole Glory Barbershop in Nashville (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **bento-showcase** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Ole Glory Barbershop** only — it must not resemble other local-business sites or AI templates.
...
**Ole Glory Barbershop** is a Restaurant / food service in Nashville.
...
- **H1 (adapt closely):** Ole Glory Barbershop — Nashville's local favorite
- **Subhead:** When's the last time you've truly felt like you could check out? With the works package…
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (Nashville), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Ole Glory Barbershop — Nashville's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Ole Glory Barbershop"
