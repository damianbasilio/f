# Stitch prompt — Paul's Towing & Recovery (paul-s-towing-recovery-minot)

Use with: `npm run stitch:prompt -- paul-s-towing-recovery-minot` then `npm run stitch:build -- paul-s-towing-recovery-minot`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Paul's Towing & Recovery**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/Paulstowingrecovery2020/
**Business:** Paul's Towing & Recovery
**Category:** Salon / spa / personal care
**Location:** 1120 42nd Street Southeast, Minot, ND 58701
**Phone:** (701) 837-9211
**Email:** paulstowingnd@gmail.com
**Review score:** 5
**Page description:** If you didn't know we can move sheds also.
**Hours:** Always open

**About / profile details:**
- **Hours:** Always open
- **Address:** Minot, ND, United States, 58703

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
If you didn't know we can move sheds also.
Hours: Always open
Address: Minot, ND, United States, 58703
Phone: 265.663 7265
Email: paulstowingnd@gmail.com
...
1. If you didn't know we can move sheds also.
2. Minot, ND, United States, North Dakota
3. Paul's Towing & Recovery's Photo
...
Reading this as: a first homepage for Paul's Towing & Recovery in Minot (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Paul's Towing & Recovery** only — it must not resemble other local-business sites or AI templates.
...
**Paul's Towing & Recovery** is a Salon / spa / personal care in Minot.
...
- **H1 (adapt closely):** If you didn't know we can move sheds also
- **Subhead:** If you didn't know we can move sheds also.
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- Paul's Towing & Recovery's Photo
- Cut & color
...
2. **Hero** — If you didn't know we can move sheds also, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Paul's Towing & Recovery"
