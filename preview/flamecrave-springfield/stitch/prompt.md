# Stitch prompt — FlameCrave (flamecrave-springfield)

Use with: `npm run stitch:prompt -- flamecrave-springfield` then `npm run stitch:build -- flamecrave-springfield`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **FlameCrave**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/FlameCrave-61560884077632/
**Business:** FlameCrave
**Category:** Restaurant / food service
**Location:** 4425 Main Street, Springfield, OR 97478
**Phone:** (541) 852-5732
**Email:** flamecrave1@gmail.com
**Review score:** 4.4
**Page description:** We had a great time putting on our first reaper challenge tonight. She started out strong but in the end couldn’t handle the 🌶️. Thank you for joining us Crispy Pare you did a great job 😊 Think you have what it takes to complete this fiery challenge? Message us for details if you want to give it a shot!!
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 4425 Main Street , Springfield, OR, United States, 97478

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
We had a great time putting on our first reaper challenge tonight. She started out strong but in the end couldn’t handle the 🌶️. Thank you for joining us Crispy Pare you did a great job 😊 Think you have what it takes to complete this fiery challenge? Message us for details if you want to give it a shot!!
Hours: Closed now
Address: 4425 Main Street , Springfield, OR, United States, 97478
Phone: 265.663 7265
Email: flamecrave1@gmail.com
...
1. We had a great time putting on our first reaper challenge tonight. She started out strong but in the end couldn’t handle the 🌶️. Thank you for joining us Crispy Pare you did a great job 😊 Think you have what it takes to complete this fiery challenge? Message us for details if you want to give it a shot!!
2. It'll be available to watch on FlameCrave's profile shortly.
...
Reading this as: a first homepage for FlameCrave in Springfield (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **magazine-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **FlameCrave** only — it must not resemble other local-business sites or AI templates.
...
**FlameCrave** is a Restaurant / food service in Springfield.
...
- **H1 (adapt closely):** FlameCrave — Springfield's local favorite
- **Subhead:** We had a great time putting on our first reaper challenge tonight. She started out stro…
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (Springfield), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — FlameCrave — Springfield's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with FlameCrave"
