// Form Submission Micro-interaction
        ...
        // Simple Parallax / Reveal logic for editorial feel
        window.addEventListener('scroll', () => {
            const scrolled = window.pageYOffset;
            const heroImage = document.querySelector('img[data-alt*="poodle"]');
            if(heroImage) {
                heroImage.style.transform = `scale(${1 + scrolled * 0.0001}) translateY(${scrolled * 0.05}px)`;
            }
        });
