# Stitch prompt — D & D Wrecker Inc (d-d-wrecker-inc-davenport)

Use with: `npm run stitch:prompt -- d-d-wrecker-inc-davenport` then `npm run stitch:build -- d-d-wrecker-inc-davenport`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **D & D Wrecker Inc**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/DDWreckerInc/
**Business:** D & D Wrecker Inc
**Category:** Salon / spa / personal care
**Location:** 21355 North Brady Street, Davenport, IA 52806
**Phone:** (563) 326-1543
**Email:** policeimpounds@gmail.com
**Review score:** 4.9
**Page description:** D & D Wrecker, Inc., Davenport. 364 likes · 7 were here. Family owned business providing 24 Hour Towing & Emergency Road Service. Local & Long Distance since
**Hours:** Always open

**About / profile details:**
- **Hours:** Always open
- **Address:** 21355 N Brady Street, Davenport, IA, United States, 52806

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
D & D Wrecker, Inc., Davenport. 364 likes · 7 were here. Family owned business providing 24 Hour Towing & Emergency Road Service. Local & Long Distance since
Hours: Always open
Address: 21355 N Brady Street, Davenport, IA, United States, 52806
Phone: 265.663 7265
Email: policeimpounds@gmail.com
...
1. Family owned business providing 24 Hour Towing & Emergency Road Service. Local & Long Distance since
...
Reading this as: a first homepage for D & D Wrecker Inc in Davenport (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **minimal-luxury** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **D & D Wrecker Inc** only — it must not resemble other local-business sites or AI templates.
...
**D & D Wrecker Inc** is a Salon / spa / personal care in Davenport.
...
**Hero direction:**
- **H1 (adapt closely):** D & D Wrecker Inc — serving Davenport
- **Subhead:** D & D Wrecker, Inc., Davenport. 364 likes · 7 were here. Family owned business providin…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- Family owned business providing 24 Hour Towing & Emergency Road Service
- Cut & color
...
2. **Hero** — D & D Wrecker Inc — serving Davenport, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with D & D Wrecker Inc"
