# Stitch prompt — Stay Sharp Barbershop (stay-sharp-barbershop-cedar-rapids)

Use with: `npm run stitch:prompt -- stay-sharp-barbershop-cedar-rapids` then `npm run stitch:build -- stay-sharp-barbershop-cedar-rapids`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Stay Sharp Barbershop**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://m.facebook.com/Stay-Sharp-barbershop-107716887315108/?ref=bookmarks
**Business:** Stay Sharp Barbershop
**Category:** Restaurant / food service
**Location:** 1506 1st Avenue Northeast, Cedar Rapids, IA 52402
**Phone:** (319) 826-6142
**Email:** 3ddabarber@gmail.com
**Review score:** 4.3
**Page description:** Stay Sharp barbershop, Cedar Rapids. 671 likes. Live for the moment, focus on the future and failure is not an option on any level!#growth#vibrations
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 1855 1st Ave SE, Cedar Rapids, IA, United States, 52403

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Stay Sharp barbershop, Cedar Rapids. 671 likes. Live for the moment, focus on the future and failure is not an option on any level!#growth#vibrations
Hours: Closed now
Address: 1855 1st Ave SE, Cedar Rapids, IA, United States, 52403
Phone: 520-858-6131
Email: 3ddabarber@gmail.com
...
1. Book your appointments for the weekend! Colcut1.com
2. Live for the moment, focus on the future and failure is not an option on any level!#growth#vibrations
3. Stay Sharp barbershop is at Col' CuTs.
...
Reading this as: a first homepage for Stay Sharp Barbershop in Cedar Rapids (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **story-column** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Stay Sharp Barbershop** only — it must not resemble other local-business sites or AI templates.
...
**Stay Sharp Barbershop** is a Restaurant / food service in Cedar Rapids.
...
- **H1 (adapt closely):** Stay Sharp Barbershop — Cedar Rapids's local favorite
- **Subhead:** Stay Sharp barbershop, Cedar Rapids. 671 likes. Live for the moment, focus on the futur…
...
2. **Hero** — Stay Sharp Barbershop — Cedar Rapids's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Stay Sharp Barbershop"
