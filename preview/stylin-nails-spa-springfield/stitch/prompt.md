# Stitch prompt — Stylin' Nails & Spa (stylin-nails-spa-springfield)

Use with: `npm run stitch:prompt -- stylin-nails-spa-springfield` then `npm run stitch:build -- stylin-nails-spa-springfield`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Stylin' Nails & Spa**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/stylinnails.spa
**Business:** Stylin' Nails & Spa
**Category:** Salon / spa / personal care
**Location:** 2775 South Campbell Avenue, Springfield, MO 65807
**Phone:** (417) 771-5458
**Email:** stylinnails.spa@gmail.com
**Review score:** 4.8
**Page description:** Introduced NEW Chance Cre8tion Collections to our salon! Bare Collection: Soft, romantic, feminine, blush-toned, elegant 🧸✨🌸 Autumn Spice: Warm, earthy, bold, cozy, autumnal !🍂🌳 Winter Wishes: Muted nudes, moody berries, winter glam✨💅❄️ Winter Delight: Moody, frosted, sophisticated, winter-inspired, shimmering ❄️💙✨ #NewNailColors #NailPolishPalette #NailInspo #NailTrends #GelPolish #NailTechLife #NailArtist #NailSalon #NailCollection #ColorStory #NailSwatches #NailLovers #FreshColors #WinterNails #BerryNails #MauveNails #PinkNails #LuxuryNails #ManicureInspo #NailDesigns #NailFashion #BeautyBusiness #NailGoals #NailObsessed #CreationProducts #ProfessionalNails #SalonQuality #NailAddict #TrendingNails #ColorOfTheSeason 💅✨❄️💕🍇
**Hours:** See Facebook page for current hours

**About / profile details:**
- **Address:** 2775 S Campbell Ave, Suite 105, Springfield, MO, United States, 65807

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Introduced NEW Chance Cre8tion Collections to our salon! Bare Collection: Soft, romantic, feminine, blush-toned, elegant 🧸✨🌸 Autumn Spice: Warm, earthy, bold, cozy, autumnal !🍂🌳 Winter Wishes: Muted nudes, moody berries, winter glam✨💅❄️ Winter Delight: Moody, frosted, sophisticated, winter-inspired, shimmering ❄️💙✨ #NewNailColors #NailPolishPalette #NailInspo #NailTrends #GelPolish #NailTechLife #NailArtist #NailSalon #NailCollection #ColorStory #NailSwatches #NailLovers #FreshColors #WinterNails #BerryNails #MauveNails #PinkNails #LuxuryNails #ManicureInspo #NailDesigns #NailFashion #BeautyBusiness #NailGoals #NailObsessed #CreationProducts #ProfessionalNails #SalonQuality #NailAddict #TrendingNails #ColorOfTheSeason 💅✨❄️💕🍇
Address: 2775 S Campbell Ave, Suite 105, Springfield, MO, United States, 65807
Phone: 417-771-5458
Email: stylinnails.spa@gmail.com

Recent posts from their Facebook page:
1. Introduced NEW Chance Cre8tion Collections to our salon! Bare Collection: Soft, romantic, feminine, blush-toned, elegant 🧸✨🌸 Autumn Spice: Warm, earthy, bold, cozy, autumnal !🍂🌳 Winter Wishes: Muted nudes, moody berries, winter glam✨💅❄️ Winter Delight: Moody, frosted, sophisticated, winter-inspired, shimmering ❄️💙✨ #NewNailColors #NailPolishPalette #NailInspo #NailTrends #GelPolish #NailTechLife #NailArtist #NailSalon #NailCollection #ColorStory #NailSwatches #NailLovers #FreshColors #WinterNails #BerryNails #MauveNails #PinkNails #LuxuryNails #ManicureInspo #NailDesigns #NailFashion #BeautyBusiness #NailGoals #NailObsessed #CreationProducts #ProfessionalNails #SalonQuality #NailAddict #TrendingNails #ColorOfTheSeason 💅✨❄️💕🍇
2. Stylin’ Nails & Spa's Photo
3. Stylin' Nails & Spa prides ourselves with top of the line manicures and pedicures from experienced professionals. Following safe and clean regulations, we keep you relaxed, refreshed, and 100% satisfied with our service.

**Recent post captions (3 — echo their voice in headlines; skip registry/SKU/listing lines):**
1. "Introduced NEW Chance Cre8tion Collections to our salon! Bare Collection: Soft, romantic, feminine, blush-toned, elegant 🧸✨🌸 Autumn Spice: Warm, earthy, bold, cozy, autumnal !🍂🌳 Winter Wishes: Muted nudes, moody berries, winter glam✨💅❄️ Winter Delight: Moody, frosted, sophisticated, winter-inspired, shimmering ❄️💙✨ #NewNailColors #NailPolishPalette #NailInspo #NailTrends #GelPolish #NailTech…"
2. "Stylin’ Nails & Spa's Photo"
3. "Stylin' Nails & Spa prides ourselves with top of the line manicures and pedicures from experienced professionals. Following safe and clean regulations, we keep you relaxed, refreshed, and 100% satisfied with our service."
...
Reading this as: a first homepage for Stylin' Nails & Spa in Springfield (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **bento-showcase** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Stylin' Nails & Spa** only — it must not resemble other local-business sites or AI templates.
...
**Stylin' Nails & Spa** is a Salon / spa / personal care in Springfield.
...
**Hero direction:**
- **H1 (adapt closely):** Stylin’ Nails & Spa's Photo
- **Subhead:** Introduced NEW Chance Cre8tion Collections to our salon! Bare Collection: Soft, romanti…
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Springfield), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Stylin’ Nails & Spa's Photo, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Stylin' Nails & Spa"
