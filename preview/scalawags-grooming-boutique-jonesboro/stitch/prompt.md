# Stitch prompt — Scalawags Grooming & Boutique (scalawags-grooming-boutique-jonesboro)

Use with: `npm run stitch:prompt -- scalawags-grooming-boutique-jonesboro` then `npm run stitch:build -- scalawags-grooming-boutique-jonesboro`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Scalawags Grooming & Boutique**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/Scalawagsboutique/
**Business:** Scalawags Grooming & Boutique
**Category:** Pet grooming / pet services
**Location:** 1107 West Parker Road, Jonesboro, AR 72404
**Phone:** (870) 680-0678
**Email:** Scalawagsgrooming@gmail.com
**Review score:** 4.8
**Page description:** Scalawags grooming, Jonesboro. 1,485 likes · 3 talking about this · 6 were here. 1107 W Parker Rd. Suite C
**Hours:** Open now

**About / profile details:**
- **Hours:** Open now
- **Address:** 1107 W Parker Rd.  Suite C , Jonesboro, AR, United States, 72404

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Scalawags grooming, Jonesboro. 1,485 likes · 3 talking about this · 6 were here. 1107 W Parker Rd. Suite C
Hours: Open now
Address: 1107 W Parker Rd.  Suite C , Jonesboro, AR, United States, 72404
Phone: 265.663 7265
Email: Scalawagsgrooming@gmail.com
...
Reading this as: a first homepage for Scalawags Grooming & Boutique in Jonesboro (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **bento-showcase** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Scalawags Grooming & Boutique** only — it must not resemble other local-business sites or AI templates.
...
**Scalawags Grooming & Boutique** is a Pet grooming / pet services in Jonesboro.
...
- **Subhead:** Scalawags grooming, Jonesboro. 1,485 likes · 3 talking about this · 6 were here. 1107 W…
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Scalawags Grooming & Boutique"
