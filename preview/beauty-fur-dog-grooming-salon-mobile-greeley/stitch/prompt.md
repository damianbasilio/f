# Stitch prompt — Beauty-Fur Dog Grooming Salon & Mobile (beauty-fur-dog-grooming-salon-mobile-greeley)

Use with: `npm run stitch:prompt -- beauty-fur-dog-grooming-salon-mobile-greeley` then `npm run stitch:build -- beauty-fur-dog-grooming-salon-mobile-greeley`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Beauty-Fur Dog Grooming Salon & Mobile**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Beauty-Fur-Dog-Grooming-100057295215690/
**Business:** Beauty-Fur Dog Grooming Salon & Mobile
**Category:** Pet grooming / pet services
**Location:** 6118 West 10th Street, Greeley, CO 80634
**Phone:** (970) 888-3173
**Email:** beautyfurgrooming1@gmail.com
**Review score:** 4.9
**Page description:** Junior Career Explorers was a doggone good time, we got to show students the skills required to become dog groomers and they even got to check out our mobile dog grooming van.
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 6118 w 10th st., 80634

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Junior Career Explorers was a doggone good time, we got to show students the skills required to become dog groomers and they even got to check out our mobile dog grooming van.
Hours: Closed now
Address: 6118 w 10th st., 80634
Phone: 265.663 7265
Email: beautyfurgrooming1@gmail.com
...
1. Junior Career Explorers was a doggone good time, we got to show students the skills required to become dog groomers and they even got to check out our mobile dog grooming van.
2. Seeing this reminds me I need to set an appt got my boy. Yall did so good last time
3. Beauty Fur Dog Grooming's Photo
...
Reading this as: a first homepage for Beauty-Fur Dog Grooming Salon & Mobile in Greeley (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Beauty-Fur Dog Grooming Salon & Mobile** only — it must not resemble other local-business sites or AI templates.
...
**Beauty-Fur Dog Grooming Salon & Mobile** is a Pet grooming / pet services in Greeley.
...
- **H1 (adapt closely):** Professional pet care in Greeley
- **Subhead:** Junior Career Explorers was a doggone good time, we got to show students the skills req…
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- Beauty Fur Dog Grooming's Photo
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Pet grooming / pet services), name, location (Greeley), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Professional pet care in Greeley, subhead, Book grooming, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Beauty-Fur Dog Grooming Salon & Mobile"
