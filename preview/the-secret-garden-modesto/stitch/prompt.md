# Stitch prompt — The Secret Garden (the-secret-garden-modesto)

Use with: `npm run stitch:prompt -- the-secret-garden-modesto` then `npm run stitch:build -- the-secret-garden-modesto`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **The Secret Garden**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/The-Secret-Garden-Restaurant-Lounge-100083223587497/
**Business:** The Secret Garden
**Category:** Restaurant / food service
**Location:** 2401 East Orangeburg Avenue, Modesto, CA 95355
**Phone:** (209) 846-9559
**Email:** Thesecretgardenrestaurant22@gmail.com
**Review score:** 4.2
**Page description:** Just went to this resturaunt "Secret Garden" WOW !!! Best Veggie Burger I have ever had. Excellent fruit bowl. The Secret Garden drink could use a tad more Fruit and less Kale. Other then that I highly recommend this place. Next time I will be going for the Great Breakfast menu that is served till 3 pm. I got there a little late for that. The menu is Primo. Great service too. 10 out of 10
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 2401 E. Orangeburg Ave, Modesto, CA, United States, 95355

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Just went to this resturaunt "Secret Garden" WOW !!! Best Veggie Burger I have ever had. Excellent fruit bowl. The Secret Garden drink could use a tad more Fruit and less Kale. Other then that I highly recommend this place. Next time I will be going for the Great Breakfast menu that is served till 3 pm. I got there a little late for that. The menu is Primo. Great service too. 10 out of 10
Hours: Closed now
Address: 2401 E. Orangeburg Ave, Modesto, CA, United States, 95355
Phone: 209-846-9559
Email: Thesecretgardenrestaurant22@gmail.com
...
1. Just went to this resturaunt "Secret Garden" WOW !!! Best Veggie Burger I have ever had. Excellent fruit bowl. The Secret Garden drink could use a tad more Fruit and less Kale. Other then that I highly recommend this place. Next time I will be going for the Great Breakfast menu that is served till 3 pm. I got there a little late for that. The menu is Primo. Great service too. 10 out of 10
2. Serving California style breakfast, Lunch & Dinner. Mimosa's, Michelada's & more delicious cocktails!
3. Noble BernisEarl McGill El Bey is feeling fantastic at The Secret Garden Restaurant & Lounge.
4. Noble BernisEarl McGill El Bey's Photo
...
Reading this as: a first homepage for The Secret Garden in Modesto (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **minimal-luxury** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **The Secret Garden** only — it must not resemble other local-business sites or AI templates.
...
**The Secret Garden** is a Restaurant / food service in Modesto.
...
**Hero direction:**
- **H1 (adapt closely):** The Secret Garden — Modesto's local favorite
- **Subhead:** Just went to this resturaunt "Secret Garden" WOW !!! Best Veggie Burger I have ever had…
...
- Next time I will be going for the Great Breakfast menu that is served till 3 pm
- The menu is Primo
- Great service too
- Daily specials
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (Modesto), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — The Secret Garden — Modesto's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with The Secret Garden"
