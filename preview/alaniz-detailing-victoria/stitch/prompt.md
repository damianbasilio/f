# Stitch prompt — Alaniz Detailing (alaniz-detailing-victoria)

Use with: `npm run stitch:prompt -- alaniz-detailing-victoria` then `npm run stitch:build -- alaniz-detailing-victoria`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Alaniz Detailing**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Alaniz-Detail-100063787983297/
**Business:** Alaniz Detailing
**Category:** Local business
**Location:** Victoria, United States
**Phone:** (361) 649-9815
**Email:** marcosalaniz87@gmail.com
**Review score:** 5
**Page description:** Alaniz Detail. 1,266 likes · 3 talking about this. Alaniz Detailing is a full-service mobile auto detailing service throughout Victoria Texas.
...
Alaniz Detail. 1,266 likes · 3 talking about this. Alaniz Detailing is a full-service mobile auto detailing service throughout Victoria Texas.
Phone: 265.663 7265
Email: marcosalaniz87@gmail.com

Recent posts from their Facebook page:
1. Had to see this one through my boy #alaniz_detail #detail #detailer #localbusiness #victoriatx
2. Alaniz Detailing is a full-service mobile auto detailing service throughout Victoria Texas.
3. Alaniz Detail is in Victoria, TX, United States.
4. It'll be available to watch on Alaniz Detail's profile shortly.
...
Reading this as: a first homepage for Alaniz Detailing in Victoria (Local business), Professional, welcoming, community-rooted tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Alaniz Detailing** only — it must not resemble other local-business sites or AI templates.
...
**Alaniz Detailing** is a Local business in Victoria.
...
- **H1 (adapt closely):** Alaniz Detailing — serving Victoria
- **Subhead:** Alaniz Detail. 1,266 likes · 3 talking about this. Alaniz Detailing is a full-service m…
- **Primary CTA:** Contact us
- **Secondary CTA:** Learn more

**Services / offerings (feature prominently with business-specific language):**
- Alaniz Detailing is a full-service mobile auto detailing service throughout Victoria Texas
- Quality service
- Local & trusted
- Easy to reach
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Local business), name, location (Victoria), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Alaniz Detailing — serving Victoria, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Alaniz Detailing"
