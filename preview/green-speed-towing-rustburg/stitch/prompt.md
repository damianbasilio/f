# Stitch prompt — Green Speed Towing (green-speed-towing-rustburg)

Use with: `npm run stitch:prompt -- green-speed-towing-rustburg` then `npm run stitch:build -- green-speed-towing-rustburg`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Green Speed Towing**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/profile.php?id=61559128812652&mibextid=LQQJ4d
**Business:** Green Speed Towing
**Category:** Trades / towing / home services
**Location:** 9228 Wards Road, Rustburg, VA 24588
**Phone:** (434) 509-2669
**Email:** GreenSpeedTowing@gmail.com
**Review score:** 4.7
**Page description:** Customer had a drop in their sugar and passed out momentarily. So glad they’re okay but unfortunately the same can’t be said for the car. Vehicles can be replaced, lives can’t. #TowLife247 #AccidentTow #FaithOverFear #SlowDownMoveOver #GreenSpeedTowing
...
Customer had a drop in their sugar and passed out momentarily. So glad they’re okay but unfortunately the same can’t be said for the car. Vehicles can be replaced, lives can’t. #TowLife247 #AccidentTow #FaithOverFear #SlowDownMoveOver #GreenSpeedTowing
Phone: 265.663 7265
Email: GreenSpeedTowing@gmail.com

Recent posts from their Facebook page:
1. Customer had a drop in their sugar and passed out momentarily. So glad they’re okay but unfortunately the same can’t be said for the car. Vehicles can be replaced, lives can’t. #TowLife247 #AccidentTow #FaithOverFear #SlowDownMoveOver #GreenSpeedTowing
2. Established in 2024 we are a small husband and wife towing service. BBB Certifed Business.
3. greenspeedtowing.square.site/?utm_id=97758_v0_s00_e0_tv0
4. Looks like the aftermath of a hornets race
...
Reading this as: a first homepage for Green Speed Towing in Rustburg (Trades / towing / home services), Reliable, local, ready when you need us — competent and direct tone, **mosaic-hero** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Green Speed Towing** only — it must not resemble other local-business sites or AI templates.
...
**Green Speed Towing** is a Trades / towing / home services in Rustburg.
...
- **H1 (adapt closely):** Green Speed Towing — trusted Rustburg service
- **Subhead:** Customer had a drop in their sugar and passed out momentarily. So glad they’re okay but…
- **Primary CTA:** Call now
- **Secondary CTA:** Request a quote

**Services / offerings (feature prominently with business-specific language):**
- #TowLife247 #AccidentTow #FaithOverFear #SlowDownMoveOver #GreenSpeedTowing
- Established in 2024 we are a small husband and wife towing service
- Greenspeedtowing
- 24/7 availability
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Trades / towing / home services), name, location (Rustburg), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Green Speed Towing — trusted Rustburg service, subhead, Call now, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Green Speed Towing"
