# Stitch prompt — K-9 Kleaners Mobile Grooming (k-9-kleaners-mobile-grooming-mcallen)

Use with: `npm run stitch:prompt -- k-9-kleaners-mobile-grooming-mcallen` then `npm run stitch:build -- k-9-kleaners-mobile-grooming-mcallen`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **K-9 Kleaners Mobile Grooming**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/k9kleanersrgv/
**Business:** K-9 Kleaners Mobile Grooming
**Category:** Pet grooming / pet services
**Location:** McAllen, McAllen, United States
**Phone:** (956) 309-6209
**Email:** Adrianmendo55@gmail.com
**Review score:** 4.3
**Page description:** Thank you for keeping us busy this holiday season! We are now taking a much needed break to rest up and come back in the new year ready to get back to you all! Any calls and messages will be returned when we are back in working hours . Thank you & Merry Christmas! 🎄
**Hours:** Open now
...
Thank you for keeping us busy this holiday season! We are now taking a much needed break to rest up and come back in the new year ready to get back to you all! Any calls and messages will be returned when we are back in working hours . Thank you & Merry Christmas! 🎄
Hours: Open now
Address: McAllen, TX, United States, 78501
Phone: 265.663 7265
Email: Adrianmendo55@gmail.com
...
Reading this as: a first homepage for K-9 Kleaners Mobile Grooming in McAllen (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **split-editorial** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **K-9 Kleaners Mobile Grooming** only — it must not resemble other local-business sites or AI templates.
...
**K-9 Kleaners Mobile Grooming** is a Pet grooming / pet services in McAllen.
...
- **Subhead:** Thank you for keeping us busy this holiday season! We are now taking a much needed brea…
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with K-9 Kleaners Mobile Grooming"
