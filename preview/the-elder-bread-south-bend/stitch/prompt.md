# Stitch prompt — The Elder Bread (the-elder-bread-south-bend)

Use with: `npm run stitch:prompt -- the-elder-bread-south-bend` then `npm run stitch:build -- the-elder-bread-south-bend`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **The Elder Bread**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/theelderbread/
**Business:** The Elder Bread
**Category:** Restaurant / food service
**Location:** 1215 East Mishawaka Avenue, South Bend, IN 46615
**Phone:** (312) 857-3544
**Email:** theelderbread@gmail.com
**Review score:** 4.6
**Page description:** The Elder Bread, South Bend. 2,293 likes · 1 talking about this · 296 were here. HOURS : MON-FRI 7-6 • SAT-SUN 8-4
Food Menu: WED-SAT 11-2
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 1215 Mishawaka Ave, South Bend, IN, United States, 46615

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
The Elder Bread, South Bend. 2,293 likes · 1 talking about this · 296 were here. HOURS : MON-FRI 7-6 • SAT-SUN 8-4
Food Menu: WED-SAT 11-2
Hours: Closed now
Address: 1215 Mishawaka Ave, South Bend, IN, United States, 46615
Phone: 312-857-3544
...
Reading this as: a first homepage for The Elder Bread in South Bend (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **bold-type-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **The Elder Bread** only — it must not resemble other local-business sites or AI templates.
...
**The Elder Bread** is a Restaurant / food service in South Bend.
...
**Hero direction:**
- **H1 (adapt closely):** The Elder Bread — South Bend's local favorite
- **Subhead:** The Elder Bread, South Bend. 2,293 likes · 1 talking about this · 296 were here. HOURS …
...
- SAT-SUN 8-4 Food Menu: WED-SAT 11-2
- Daily specials
- Catering & events
- Dine-in & takeout
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (South Bend), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — The Elder Bread — South Bend's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with The Elder Bread"
