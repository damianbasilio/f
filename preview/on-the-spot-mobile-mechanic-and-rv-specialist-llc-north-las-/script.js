// Simple micro-interaction for mobile menu
        const menuBtn = document.getElementById('mobile-menu-btn');
        menuBtn.addEventListener('click', () => {
            alert('Mobile menu toggled. In a production environment, this would open a slide-out drawer with navigation links.');
        });

        // Form feedback state (mockup)
