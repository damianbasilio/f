# Stitch prompt — Ritzee Florist | Interior Design & Special Events (ritzee-florist-interior-design-special-events-memphis)

Use with: `npm run stitch:prompt -- ritzee-florist-interior-design-special-events-memphis` then `npm run stitch:build -- ritzee-florist-interior-design-special-events-memphis`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Ritzee Florist | Interior Design & Special Events**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/Ritzee1234/
**Business:** Ritzee Florist | Interior Design & Special Events
**Category:** Local business
**Location:** 306 South Dudley Street, Memphis, TN 38104
**Phone:** (901) 525-1645
**Email:** sharon.coleman38@yahoo.com
**Review score:** 5
**Page description:** Ritzee Florist and Interior Designs, Memphis. 925 likes · 19 talking about this · 366 were here. Exclusive Florist For Select Clients and Referrals.
**Hours:** Open now

**About / profile details:**
- **Hours:** Open now
- **Address:** 306 S Dudley St, Memphis, TN, United States, 38104

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Ritzee Florist and Interior Designs, Memphis. 925 likes · 19 talking about this · 366 were here. Exclusive Florist For Select Clients and Referrals.
Hours: Open now
Address: 306 S Dudley St, Memphis, TN, United States, 38104
Phone: 265.663 7265
Email: sharon.coleman38@yahoo.com
...
1. Plants can always be a pleasant sympathy or getwell design.
2. Ritzee Florist and Interior Designs's Photo
3. Exclusive Florist For Select Clients and Referrals.
4. Delivery · Contactless delivery · Reservations…
...
Reading this as: a first homepage for Ritzee Florist | Interior Design & Special Events in Memphis (Local business), Professional, welcoming, community-rooted tone, **bold-type-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Ritzee Florist | Interior Design & Special Events** only — it must not resemble other local-business sites or AI templates.
...
**Ritzee Florist | Interior Design & Special Events** is a Local business in Memphis.
...
- **H1 (adapt closely):** Plants can always be a pleasant sympathy or getwell design
- **Subhead:** Ritzee Florist and Interior Designs, Memphis. 925 likes · 19 talking about this · 366 w…
- **Primary CTA:** Contact us
- **Secondary CTA:** Learn more

**Services / offerings (feature prominently with business-specific language):**
- Delivery · Contactless delivery · Reservations…
- Quality service
- Local & trusted
- Easy to reach
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Local business), name, location (Memphis), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Plants can always be a pleasant sympathy or getwell design, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Ritzee Florist | Interior Design & Special Events"
