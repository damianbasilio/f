// Simple micro-interaction for the industrial items
        document.querySelectorAll('input, select').forEach(el => {
            el.addEventListener('focus', () => {
                el.parentElement.querySelector('label').style.letterSpacing = '0.2em';
            });
            el.addEventListener('blur', () => {
                el.parentElement.querySelector('label').style.letterSpacing = '0.1em';
            });
        });
