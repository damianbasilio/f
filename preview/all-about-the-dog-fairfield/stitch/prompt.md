# Stitch prompt — All About The Dog (all-about-the-dog-fairfield)

Use with: `npm run stitch:prompt -- all-about-the-dog-fairfield` then `npm run stitch:build -- all-about-the-dog-fairfield`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **All About The Dog**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/allaboutthedogfairfield/
**Business:** All About The Dog
**Category:** Pet grooming / pet services
**Location:** 119 Post Road, Fairfield, CT 06824
**Phone:** (203) 576-8910
**Email:** allaboutthedog123@gmail.com
**Review score:** 4.8
**Page description:** All About the Dog Grooming Fairfield, Fairfield. 486 likes · 68 were here. We are full service dog grooming salon with 15 year experience in dog grooming business. . Come check
**Hours:** Open now

**About / profile details:**
- **Hours:** Open now
- **Address:** 119 post rd, Fairfield, CT, United States, 06824

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
All About the Dog Grooming Fairfield, Fairfield. 486 likes · 68 were here. We are full service dog grooming salon with 15 year experience in dog grooming business. . Come check
Hours: Open now
Address: 119 post rd, Fairfield, CT, United States, 06824
Phone: 265.663 7265
Email: allaboutthedog123@gmail.com
...
1. All About the Dog Grooming Fairfield's Photo
2. We are full service dog grooming salon with 15 year experience in dog grooming business. . Come check
...
Reading this as: a first homepage for All About The Dog in Fairfield (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **cinematic-bleed** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **All About The Dog** only — it must not resemble other local-business sites or AI templates.
...
**All About The Dog** is a Pet grooming / pet services in Fairfield.
...
- **H1 (adapt closely):** Professional pet care in Fairfield
- **Subhead:** All About the Dog Grooming Fairfield, Fairfield. 486 likes · 68 were here. We are full …
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- All About the Dog Grooming Fairfield's Photo
- We are full service dog grooming salon with 15 year experience in dog grooming business
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Pet grooming / pet services), name, location (Fairfield), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Professional pet care in Fairfield, subhead, Book grooming, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with All About The Dog"
