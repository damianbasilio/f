// Form Validation UI micro-interactions
        ...
        // Simple smooth entrance for section lines
        ...
        document.querySelectorAll('.editorial-line').forEach(line => {
            line.style.width = '0%';
            line.style.transition = 'width 1.5s cubic-bezier(0.2, 1, 0.3, 1)';
