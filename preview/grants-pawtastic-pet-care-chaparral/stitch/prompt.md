# Stitch prompt — Grants Pawtastic Pet Care (grants-pawtastic-pet-care-chaparral)

Use with: `npm run stitch:prompt -- grants-pawtastic-pet-care-chaparral` then `npm run stitch:build -- grants-pawtastic-pet-care-chaparral`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Grants Pawtastic Pet Care**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/Pawtasticpetcare12/
**Business:** Grants Pawtastic Pet Care
**Category:** Local business
**Location:** Annapolis, Chaparral, United States
**Phone:** (636) 633-6556
**Email:** pawtasticpetcare12@yahoo.com
**Review score:** 5
**Page description:** We offer a variety of pet services to care for your pet's daily needs, keeping your pets exercised, healthy, socialized, loved on, and engaged in life. These services may include walks, adventures, feedings, play times, or just good companionship.
**Hours:** Always open
...
We offer a variety of pet services to care for your pet's daily needs, keeping your pets exercised, healthy, socialized, loved on, and engaged in life. These services may include walks, adventures, feedings, play times, or just good companionship.
Hours: Always open
Address: Annapolis, MD, United States
Phone: 265.663 7265
Email: pawtasticpetcare12@yahoo.com
...
1. Ally Harrison Greenleaf Birthday Boy!! 🥳🥰
2. 🎉We are screaming Happy Birthday to our favorite Buddy boy ever!! 🎂🥳🎈 We all love you so much! #ppcpups #annapolispets #birthdayboy #goldendoodle #petsittingbusiness #dogwalking #bestboy
3. We offer a variety of pet services to care for your pet's daily needs, keeping your pets exercised, healthy, socialized, loved on, and engaged in life. These services may include walks, adventures, feedings, play times, or just good companionship.
4. Annapolis, MD, United States, Maryland
5. Pawtastic Pet Care Service LLC shared a memory.
...
Reading this as: a first homepage for Grants Pawtastic Pet Care in Chaparral (Local business), Professional, welcoming, community-rooted tone, **mosaic-hero** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Grants Pawtastic Pet Care** only — it must not resemble other local-business sites or AI templates.
...
**Grants Pawtastic Pet Care** is a Local business in Chaparral.
...
**Hero direction:**
- **H1 (adapt closely):** Ally Harrison Greenleaf Birthday Boy!! 🥳🥰
- **Subhead:** We offer a variety of pet services to care for your pet's daily needs, keeping your pet…
- **Primary CTA:** Contact us
- **Secondary CTA:** Learn more

**Services / offerings (feature prominently with business-specific language):**
- These services may include walks, adventures, feedings, play times, or just good companionship
- Pawtastic Pet Care Service LLC shared a memory
- Quality service
- Local & trusted
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Local business), name, location (Chaparral), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Ally Harrison Greenleaf Birthday Boy!! 🥳🥰, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Grants Pawtastic Pet Care"
