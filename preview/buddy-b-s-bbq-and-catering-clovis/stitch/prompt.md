# Stitch prompt — Buddy B’s bbq and catering (buddy-b-s-bbq-and-catering-clovis)

Use with: `npm run stitch:prompt -- buddy-b-s-bbq-and-catering-clovis` then `npm run stitch:build -- buddy-b-s-bbq-and-catering-clovis`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Buddy B’s bbq and catering**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Buddy-Bs-BBQ-Catering-61578650822653/
**Business:** Buddy B’s bbq and catering
**Category:** Restaurant / food service
**Location:** 701 North Prince Street, Clovis, NM 88101
**Phone:** (575) 760-4642
**Email:** Bigboi88702@gmail.com
**Review score:** 4.5
**Page description:** Good morning, we are informing you that due to graduation ceremonies and other events, we will be closed this Friday and next Friday, we apologize for any inconvenience this may cause and will resume our regular operating hours soon.
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 701 N Prince, Clovis, NM, United States, 88101

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Good morning, we are informing you that due to graduation ceremonies and other events, we will be closed this Friday and next Friday, we apologize for any inconvenience this may cause and will resume our regular operating hours soon.
Hours: Closed now
Address: 701 N Prince, Clovis, NM, United States, 88101
Phone: 265.663 7265
Email: Bigboi88702@gmail.com
...
1. Good morning, we are informing you that due to graduation ceremonies and other events, we will be closed this Friday and next Friday, we apologize for any inconvenience this may cause and will resume our regular operating hours soon.
2. Looking for good backyard BBQ that isn’t over powered by smoke flavor your search is over
3. 701 N Prince, Clovis, NM, United States, New Mexico
4. Buddy B’s BBQ & Catering is with Cristy Vann.
...
Reading this as: a first homepage for Buddy B’s bbq and catering in Clovis (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **magazine-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Buddy B’s bbq and catering** only — it must not resemble other local-business sites or AI templates.
...
**Buddy B’s bbq and catering** is a Restaurant / food service in Clovis.
...
**Hero direction:**
- **H1 (adapt closely):** Buddy B’s bbq and catering — Clovis's local favorite
- **Subhead:** Good morning, we are informing you that due to graduation ceremonies and other events, …
...
2. **Hero** — Buddy B’s bbq and catering — Clovis's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Buddy B’s bbq and catering"
