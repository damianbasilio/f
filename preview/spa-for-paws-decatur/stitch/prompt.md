# Stitch prompt — Spa for Paws (spa-for-paws-decatur)

Use with: `npm run stitch:prompt -- spa-for-paws-decatur` then `npm run stitch:build -- spa-for-paws-decatur`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Spa for Paws**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/julies-spa-for-paws-354172644737410/
**Business:** Spa for Paws
**Category:** Pet grooming / pet services
**Location:** 3668 East William Street Road, Decatur, IL 62521
**Phone:** (217) 706-5252
**Email:** harlessjulie@yahoo.com
**Review score:** 4.3
**Page description:** When this happens, it's usually because the owner only shared it with a small group of people, changed who can see it or it's been deleted.
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 3668 E. William, Decatur, IL, United States, 62521
...
3. Julie's Spa for Paws updated their status.
4. I have 40 yrs.grooming experience. Very reasonable pricing. Full Dog groom starts at $35 Cat full groom starts at $40
5. 3668 E. William, Decatur, IL, United States, Illinois
...
Reading this as: a first homepage for Spa for Paws in Decatur (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **boutique-window** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Spa for Paws** only — it must not resemble other local-business sites or AI templates.
...
**Spa for Paws** is a Pet grooming / pet services in Decatur.
...
- **Subhead:** When this happens, it's usually because the owner only shared it with a small group of …
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- Grooming experience
- Full Dog groom starts at $35 Cat full groom starts at $40
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Spa for Paws"
