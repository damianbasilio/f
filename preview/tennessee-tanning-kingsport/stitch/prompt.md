# Stitch prompt — Tennessee Tanning (tennessee-tanning-kingsport)

Use with: `npm run stitch:prompt -- tennessee-tanning-kingsport` then `npm run stitch:build -- tennessee-tanning-kingsport`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Tennessee Tanning**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Tennessee-Tanning-100037288485994/
**Business:** Tennessee Tanning
**Category:** Salon / spa / personal care
**Location:** 1024 South Wilcox Drive, Kingsport, TN 37660
**Phone:** (423) 378-6200
**Email:** tennessee.tanning@yahoo.com
**Review score:** 4.5
**Page description:** Tennessee Tanning, Kingsport. 603 likes · 212 were here. Clean and happy environment
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 1024 S Wilcox Dr, Kingsport, TN, United States, 37660

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Tennessee Tanning, Kingsport. 603 likes · 212 were here. Clean and happy environment
Hours: Closed now
Address: 1024 S Wilcox Dr, Kingsport, TN, United States, 37660
Phone: 265.663 7265
Email: tennessee.tanning@yahoo.com
...
1. We are sorry but we will be closed this Saturday May 2, 2026
...
Reading this as: a first homepage for Tennessee Tanning in Kingsport (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **minimal-luxury** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Tennessee Tanning** only — it must not resemble other local-business sites or AI templates.
...
**Tennessee Tanning** is a Salon / spa / personal care in Kingsport.
...
- **H1 (adapt closely):** We are sorry but we will be closed this Saturday May 2, 2026
- **Subhead:** Tennessee Tanning, Kingsport. 603 likes · 212 were here. Clean and happy environment
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Kingsport), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — We are sorry but we will be closed this Saturday May 2, 2026, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Tennessee Tanning"
