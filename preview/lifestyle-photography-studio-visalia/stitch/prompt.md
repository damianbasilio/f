# Stitch prompt — Lifestyle Photography Studio (lifestyle-photography-studio-visalia)

Use with: `npm run stitch:prompt -- lifestyle-photography-studio-visalia` then `npm run stitch:build -- lifestyle-photography-studio-visalia`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Lifestyle Photography Studio**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/lifestylephotographystudio559/
**Business:** Lifestyle Photography Studio
**Category:** Local business
**Location:** 3105 West Cambridge Avenue, Visalia, CA 93277
**Phone:** (559) 308-6763
**Email:** lifestylephotographystudio@gmail.com
**Review score:** 5
**Page description:** Lifestyle Photography Studio, Visalia. 801 likes. Children, Family, Newborn, Couples, Senior, Engagements, 
Quinceanera & Baptism (No Event Coverage)
**Hours:** Open now

**About / profile details:**
- **Hours:** Open now
- **Address:** 3105 W. Cambridge Ave, Visalia, CA, United States, 93277

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Lifestyle Photography Studio, Visalia. 801 likes. Children, Family, Newborn, Couples, Senior, Engagements, 
Quinceanera & Baptism (No Event Coverage)
Hours: Open now
Address: 3105 W. Cambridge Ave, Visalia, CA, United States, 93277
Phone: 559-308-6763
...
1. This little doll came to this world a bit early ready to shine! She has the sleeping positions down. ☺📸
2. Children, Family, Newborn, Couples, Senior, Engagements, Quinceanera & Baptism (No Event Coverage)
3. It'll be available to watch on Lifestyle Photography Studio's profile shortly.
...
Reading this as: a first homepage for Lifestyle Photography Studio in Visalia (Local business), Professional, welcoming, community-rooted tone, **bento-showcase** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Lifestyle Photography Studio** only — it must not resemble other local-business sites or AI templates.
...
**Lifestyle Photography Studio** is a Local business in Visalia.
...
**Hero direction:**
- **H1 (adapt closely):** Lifestyle Photography Studio — serving Visalia
- **Subhead:** Lifestyle Photography Studio, Visalia. 801 likes. Children, Family, Newborn, Couples, S…
...
2. **Hero** — Lifestyle Photography Studio — serving Visalia, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Lifestyle Photography Studio"
