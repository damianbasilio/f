# Design QA — richardson-roadside-assistance-scranton-scranton
...
- WARN: 9 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 9 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
