# Stitch prompt — K-9 Designs Mobile Dog Grooming (k-9-designs-mobile-dog-grooming-orem)

Use with: `npm run stitch:prompt -- k-9-designs-mobile-dog-grooming-orem` then `npm run stitch:build -- k-9-designs-mobile-dog-grooming-orem`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **K-9 Designs Mobile Dog Grooming**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/k9designspetgrooming/
**Business:** K-9 Designs Mobile Dog Grooming
**Category:** Pet grooming / pet services
**Location:** Provo, Orem, United States
**Phone:** (801) 360-1668
**Email:** K9DesignsOnline@gmail.com
**Review score:** 3.9
**Page description:** It'll be available to watch on K9 Designs Mobile Grooming's profile shortly.
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** Provo, UT, United States, 84601

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
It'll be available to watch on K9 Designs Mobile Grooming's profile shortly.
Hours: Closed now
Address: Provo, UT, United States, 84601
Phone: 265.663 7265
Email: K9DesignsOnline@gmail.com
...
1. Lady girl she is just so cute I can't stand it
2. Utah County's Mobile Grooming Serive
3. Provo, UT, United States, Utah
4. It'll be available to watch on K9 Designs Mobile Grooming's profile shortly.
...
Reading this as: a first homepage for K-9 Designs Mobile Dog Grooming in Orem (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **cardless-flow** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **K-9 Designs Mobile Dog Grooming** only — it must not resemble other local-business sites or AI templates.
...
**K-9 Designs Mobile Dog Grooming** is a Pet grooming / pet services in Orem.
...
- **H1 (adapt closely):** Professional pet care in Orem
- **Subhead:** It'll be available to watch on K9 Designs Mobile Grooming's profile shortly.
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- Utah County's Mobile Grooming Serive
- It'll be available to watch on K9 Designs Mobile Grooming's profile shortly
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Pet grooming / pet services), name, location (Orem), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Professional pet care in Orem, subhead, Book grooming, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with K-9 Designs Mobile Dog Grooming"
