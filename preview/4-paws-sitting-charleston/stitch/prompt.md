# Stitch prompt — 4 Paws Sitting (4-paws-sitting-charleston)

Use with: `npm run stitch:prompt -- 4-paws-sitting-charleston` then `npm run stitch:build -- 4-paws-sitting-charleston`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **4 Paws Sitting**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** http://www.facebook.com/4-Paws-Sitting-518124105034925/
**Business:** 4 Paws Sitting
**Category:** Local business
**Location:** Charleston, United States
**Phone:** (304) 444-0821
**Email:** phoenixwv2015@gmail.com
**Review score:** 5
...
1. 4 Paws Sitting offers in-home pet care to the Kanawha Valley. Services include: Dog walking; in-home
2. South Charleston, WV · Dunbar, WV · Charleston, WV
...
5. 4 Paws Sitting updated their status.
...
Reading this as: a first homepage for 4 Paws Sitting in Charleston (Local business), Professional, welcoming, community-rooted tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **4 Paws Sitting** only — it must not resemble other local-business sites or AI templates.
...
**4 Paws Sitting** is a Local business in Charleston.
...
**Hero direction:**
- **H1 (adapt closely):** 4 Paws Sitting — serving Charleston
...
- 4 Paws Sitting offers in-home pet care to the Kanawha Valley
- Services include: Dog walking; in-home
- Quality service
- Local & trusted
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Local business), name, location (Charleston), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — 4 Paws Sitting — serving Charleston, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with 4 Paws Sitting"
