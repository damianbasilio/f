# Stitch prompt — Diamonds Nail Salon (diamonds-nail-salon-lancaster)

Use with: `npm run stitch:prompt -- diamonds-nail-salon-lancaster` then `npm run stitch:build -- diamonds-nail-salon-lancaster`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Diamonds Nail Salon**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/DiamondsNail120/
**Business:** Diamonds Nail Salon
**Category:** Salon / spa / personal care
**Location:** 120 South Queen Street, Lancaster, PA 17603
**Phone:** (717) 208-7343
**Email:** Diamondsnail120@gmail.com
**Review score:** 4.5
**Page description:** Diamonds Nail, Lancaster. 217 likes · 5 talking about this · 160 were here. Professional Nail Services...
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 120 South Queen Street, Lancaster, PA, United States, 17603

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Diamonds Nail, Lancaster. 217 likes · 5 talking about this · 160 were here. Professional Nail Services...
Hours: Closed now
Address: 120 South Queen Street, Lancaster, PA, United States, 17603
Phone: 717-208-7343
Email: Diamondsnail120@gmail.com
...
Reading this as: a first homepage for Diamonds Nail Salon in Lancaster (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **bento-showcase** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Diamonds Nail Salon** only — it must not resemble other local-business sites or AI templates.
...
**Diamonds Nail Salon** is a Salon / spa / personal care in Lancaster.
...
**Hero direction:**
- **H1 (adapt closely):** Diamonds Nail Salon — serving Lancaster
- **Subhead:** Diamonds Nail, Lancaster. 217 likes · 5 talking about this · 160 were here. Professiona…
...
2. **Hero** — Diamonds Nail Salon — serving Lancaster, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Diamonds Nail Salon"
