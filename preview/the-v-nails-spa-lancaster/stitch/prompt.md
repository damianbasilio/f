# Stitch prompt — The V Nails Spa (the-v-nails-spa-lancaster)

Use with: `npm run stitch:prompt -- the-v-nails-spa-lancaster` then `npm run stitch:build -- the-v-nails-spa-lancaster`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **The V Nails Spa**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/thevnailspa/
**Business:** The V Nails Spa
**Category:** Salon / spa / personal care
**Location:** 2405 Covered Bridge Drive, Lancaster, PA 17602
**Phone:** (717) 517-8248
**Email:** ivytran185@yahoo.com
**Review score:** 4.3
**Page description:** The V Nails - Spa, Lancaster. 407 likes · 30 talking about this · 196 were here. Our nails salon provides upscale  beauty services in Lancaster, Pennsylvania: nails, spa, dipping pow
**Hours:** Closing Soon

**About / profile details:**
- **Hours:** Closing Soon
- **Address:** 2405 Covered Bridge Drive, Lancaster, PA, United States, 17602

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
The V Nails - Spa, Lancaster. 407 likes · 30 talking about this · 196 were here. Our nails salon provides upscale  beauty services in Lancaster, Pennsylvania: nails, spa, dipping pow
Hours: Closing Soon
Address: 2405 Covered Bridge Drive, Lancaster, PA, United States, 17602
Phone: (717) 517-8248
Email: ivytran185@yahoo.com
...
1. Our nails salon provides upscale beauty services in Lancaster, Pennsylvania: nails, spa, dipping pow
2. It'll be available to watch on The V Nails - Spa's profile shortly.
...
Reading this as: a first homepage for The V Nails Spa in Lancaster (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **cinematic-bleed** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **The V Nails Spa** only — it must not resemble other local-business sites or AI templates.
...
**The V Nails Spa** is a Salon / spa / personal care in Lancaster.
...
**Hero direction:**
- **H1 (adapt closely):** The V Nails Spa — serving Lancaster
- **Subhead:** The V Nails - Spa, Lancaster. 407 likes · 30 talking about this · 196 were here. Our na…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- Our nails salon provides upscale beauty services in Lancaster, Pennsylvania: nails, spa, dipping pow
- Cut & color
...
2. **Hero** — The V Nails Spa — serving Lancaster, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with The V Nails Spa"
