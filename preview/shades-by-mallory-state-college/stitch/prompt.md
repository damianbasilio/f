# Stitch prompt — Shades by Mallory (shades-by-mallory-state-college)

Use with: `npm run stitch:prompt -- shades-by-mallory-state-college` then `npm run stitch:build -- shades-by-mallory-state-college`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Shades by Mallory**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/shadesbymallory?mibextid=LQQJ4d
**Business:** Shades by Mallory
**Category:** Salon / spa / personal care
**Location:** 42 High Meadow Lane, State College, PA 16803
**Phone:** (804) 720-5361
**Email:** maldevore@gmail.com
**Review score:** Not provided
**Page description:** Shades by Mallory, State College. 453 likes · 2 talking about this. Provides Spray Tans
**Hours:** See Facebook page for current hours

**About / profile details:**
- **Address:** 42 High Meadow Lane, State College, PA, United States

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Shades by Mallory, State College. 453 likes · 2 talking about this. Provides Spray Tans
Address: 42 High Meadow Lane, State College, PA, United States
Phone: 804-720-5361
Email: maldevore@gmail.com

**Recent post captions (0 — echo their voice in headlines; skip registry/SKU/listing lines):**
Use Facebook page description for copy voice — skip listing/registration post lines.
...
Reading this as: a first homepage for Shades by Mallory in State College (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **cinematic-bleed** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Shades by Mallory** only — it must not resemble other local-business sites or AI templates.
...
**Shades by Mallory** is a Salon / spa / personal care in State College.
...
**Hero direction:**
- **H1 (adapt closely):** Shades by Mallory — serving State College
- **Subhead:** Shades by Mallory, State College. 453 likes · 2 talking about this. Provides Spray Tans
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (State College), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Shades by Mallory — serving State College, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Shades by Mallory"
