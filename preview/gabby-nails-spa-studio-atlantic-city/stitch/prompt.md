# Stitch prompt — Gabby Nails & Spa Studio (gabby-nails-spa-studio-atlantic-city)

Use with: `npm run stitch:prompt -- gabby-nails-spa-studio-atlantic-city` then `npm run stitch:build -- gabby-nails-spa-studio-atlantic-city`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Gabby Nails & Spa Studio**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** http://www.facebook.com/gabbynailsAC
**Business:** Gabby Nails & Spa Studio
**Category:** Salon / spa / personal care
**Location:** 4213 Ventnor Avenue, Atlantic City, NJ 08401
**Phone:** (609) 340-8557
**Email:** gabbynailsAC@gmail.com
**Review score:** 4.8
**Page description:** Gabby Nails & Spa Studio, Atlantic City. 50 likes · 7 were here. Nail Salon
...
Reading this as: a first homepage for Gabby Nails & Spa Studio in Atlantic City (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **split-editorial** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Gabby Nails & Spa Studio** only — it must not resemble other local-business sites or AI templates.
...
**Gabby Nails & Spa Studio** is a Salon / spa / personal care in Atlantic City.
...
**Hero direction:**
- **H1 (adapt closely):** Gabby Nails & Spa Studio's Photo
- **Subhead:** Gabby Nails & Spa Studio, Atlantic City. 50 likes · 7 were here. Nail Salon
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Atlantic City), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Gabby Nails & Spa Studio's Photo, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Gabby Nails & Spa Studio"
