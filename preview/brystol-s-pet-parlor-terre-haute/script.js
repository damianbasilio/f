// Header scroll behavior
        ...
        document.getElementById('groomingRequest')?.addEventListener('submit', (e) => {
            e.preventDefault();
            ...
            setTimeout(() => {
                btn.innerHTML = '<span class="material-symbols-outlined">check_circle</span> Sent Successfully!';
