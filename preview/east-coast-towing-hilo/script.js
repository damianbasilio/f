// Micro-interaction: Header opacity on scroll
        ...
        // Hard shadow hover effect enhancement
        document.querySelectorAll('.hard-shadow').forEach(el => {
            ...
            el.addEventListener('mouseup', () => {
                ...
                el.style.boxShadow = '4px 4px 0px 0px rgba(0, 0, 0, 1)';
            });
        });
