# Stitch prompt — King's Mechanic Shop (king-s-mechanic-shop-killeen)

Use with: `npm run stitch:prompt -- king-s-mechanic-shop-killeen` then `npm run stitch:build -- king-s-mechanic-shop-killeen`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **King's Mechanic Shop**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/kingsmechanicshop1/
**Business:** King's Mechanic Shop
**Category:** Trades / towing / home services
**Location:** 3281 Chaparral Road, Killeen, TX 76542
**Phone:** (254) 245-8020
**Email:** Kingsmechanicshop1@gmail.com
**Review score:** 4.9
**Page description:** Chevrolet express 3500 A/C blower motor not working Harness and resistor burn by blower motor
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 3281 Chaparral Road, Killeen, TX, United States, 76542

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Chevrolet express 3500 A/C blower motor not working Harness and resistor burn by blower motor
Hours: Closed now
Address: 3281 Chaparral Road, Killeen, TX, United States, 76542
Phone: 254-245-8020
Email: Kingsmechanicshop1@gmail.com
...
1. Chevrolet express 3500 A/C blower motor not working Harness and resistor burn by blower motor
2. King’s Mechanic Shop's Photo
...
Reading this as: a first homepage for King's Mechanic Shop in Killeen (Trades / towing / home services), Reliable, local, ready when you need us — competent and direct tone, **cardless-flow** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **King's Mechanic Shop** only — it must not resemble other local-business sites or AI templates.
...
**King's Mechanic Shop** is a Trades / towing / home services in Killeen.
...
**Hero direction:**
- **H1 (adapt closely):** King's Mechanic Shop — trusted Killeen service
- **Subhead:** Chevrolet express 3500 A/C blower motor not working Harness and resistor burn by blower…
...
2. **Hero** — King's Mechanic Shop — trusted Killeen service, subhead, Call now, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with King's Mechanic Shop"
