# Stitch prompt — Nailcessity (nailcessity-lancaster)

Use with: `npm run stitch:prompt -- nailcessity-lancaster` then `npm run stitch:build -- nailcessity-lancaster`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Nailcessity**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Nailcessity-100057135293934/
**Business:** Nailcessity
**Category:** Salon / spa / personal care
**Location:** 2503 Lititz Pike, Lancaster, PA 17601
**Phone:** (717) 569-1057
**Email:** nailcessity2012@yahoo.com
**Review score:** 4.9
**Page description:** Nailcessity, Lancaster. 659 likes · 6 talking about this · 645 were here. Your Needs Fullfilled @ Nailcessity
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 2503 Lititz Pike, Lancaster, PA, United States, 17601

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Nailcessity, Lancaster. 659 likes · 6 talking about this · 645 were here. Your Needs Fullfilled @ Nailcessity
Hours: Closed now
Address: 2503 Lititz Pike, Lancaster, PA, United States, 17601
Phone: 717-569-1057
Email: nailcessity2012@yahoo.com
...
1. Today’s special is a Gel Manicure for $24.99. Please call 717-569-1057 to schedule an appointment.
2. Your Needs Fullfilled @ Nailcessity
3. 2503 Lititz Pike, Lancaster, PA, United States, Pennsylvania
...
Reading this as: a first homepage for Nailcessity in Lancaster (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **diagonal-cut** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Nailcessity** only — it must not resemble other local-business sites or AI templates.
...
**Nailcessity** is a Salon / spa / personal care in Lancaster.
...
- **H1 (adapt closely):** Nailcessity — serving Lancaster
- **Subhead:** Nailcessity, Lancaster. 659 likes · 6 talking about this · 645 were here. Your Needs Fu…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- Today’s special is a Gel Manicure for $24
- Cut & color
...
2. **Hero** — Nailcessity — serving Lancaster, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Nailcessity"
