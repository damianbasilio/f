# Da Wash Auto Spa — compact brief

Agent-facing summary. Full gates and Stitch fields remain in `brief.md`.

## Gates

- **Email:** Dawashautospa@gmail.com (PASS)
- **Activity:** PASS — Active Facebook page with content and 3 post caption(s) scraped
- **Human approval:** PASS

## Business

- **Name:** Da Wash Auto Spa
- **Location:** Mobile, United States
- **Live URL:** https://www.facebook.com/Dawashautospa/
- **Email:** Dawashautospa@gmail.com
- **Phone:** (251) 303-4959
- **Tagline:** 🚘✨ Detail season is here! ✨🚘 Mini • Full • Basic – we’ve got a package for every car 💦 💬 DM for pricing 🎉 Discounts running all March! 👉 Don’t wait, give your car the spa day

## Mockup angle

- **H1:** DA WASH is in Mobile, AL, United States
...
https://damianbasilio.github.io/f/preview/da-wash-auto-spa-mobile/
