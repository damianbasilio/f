# Stitch prompt — Live Laugh Lather Mobile Grooming (live-laugh-lather-mobile-grooming-augusta)

Use with: `npm run stitch:prompt -- live-laugh-lather-mobile-grooming-augusta` then `npm run stitch:build -- live-laugh-lather-mobile-grooming-augusta`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Live Laugh Lather Mobile Grooming**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/livelaughlathergrooming
**Business:** Live Laugh Lather Mobile Grooming
**Category:** Pet grooming / pet services
**Location:** Evans, Augusta, United States
**Phone:** (980) 354-1152
**Email:** livelaughlathergrooming@gmail.com
**Review score:** 4.8
**Page description:** Live Laugh Lather, Evans. 1,770 likes · 29 talking about this · 57 were here. Hi, welcome to Live Laugh Lather!  We are dedicated to offering a safe, convenient, and stress free grooming experience....
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** Evans, GA, United States

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Live Laugh Lather, Evans. 1,770 likes · 29 talking about this · 57 were here. Hi, welcome to Live Laugh Lather!  We are dedicated to offering a safe, convenient, and stress free grooming experience....
Hours: Closed now
Address: Evans, GA, United States
Phone: 265.663 7265
Email: livelaughlathergrooming@gmail.com
...
1. Finlee and Elvis! 🩷💚✨️🐾 #livelaughlather #goldenretrieverlove #ilovemyjob #lablove #thankyou
2. Hi, welcome to Live Laugh Lather! We are dedicated to offering a safe, convenient, and stress free grooming experience. Servicing Evans, Martinez, and the Augusta area.
3. Evans, GA, United States, Georgia
4. It'll be available to watch on Live Laugh Lather's profile shortly.
...
Reading this as: a first homepage for Live Laugh Lather Mobile Grooming in Augusta (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **magazine-stack** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Live Laugh Lather Mobile Grooming** only — it must not resemble other local-business sites or AI templates.
...
**Live Laugh Lather Mobile Grooming** is a Pet grooming / pet services in Augusta.
...
- **H1 (adapt closely):** Professional pet care in Augusta
- **Subhead:** Live Laugh Lather, Evans. 1,770 likes · 29 talking about this · 57 were here. Hi, welco…
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- We are dedicated to offering a safe, convenient, and stress free grooming experience
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Pet grooming / pet services), name, location (Augusta), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Professional pet care in Augusta, subhead, Book grooming, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Live Laugh Lather Mobile Grooming"
