# Stitch prompt — Brush Nails (brush-nails-olathe)

Use with: `npm run stitch:prompt -- brush-nails-olathe` then `npm run stitch:build -- brush-nails-olathe`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Brush Nails**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Brush-Nails-KC-61557240179838/
**Business:** Brush Nails
**Category:** Salon / spa / personal care
**Location:** 1705 South Mur-Len Road, Olathe, KS 66062
**Phone:** (913) 907-0488
**Email:** brushnailskc@gmail.com
**Review score:** 4.9
**Page description:** Brush Nails KC, Olathe. 479 likes · 5 talking about this · 8 were here. Nail Salon
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 1705 S Mur-Len Rd, Olathe, KS, United States, 66062

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Brush Nails KC, Olathe. 479 likes · 5 talking about this · 8 were here. Nail Salon
Hours: Closed now
Address: 1705 S Mur-Len Rd, Olathe, KS, United States, 66062
Phone: 913-907-0488
Email: brushnailskc@gmail.com
...
Reading this as: a first homepage for Brush Nails in Olathe (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **split-editorial** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Brush Nails** only — it must not resemble other local-business sites or AI templates.
...
**Brush Nails** is a Salon / spa / personal care in Olathe.
...
- **H1 (adapt closely):** Summertime Blooms! 🌸🌺🌼
- **Subhead:** Brush Nails KC, Olathe. 479 likes · 5 talking about this · 8 were here. Nail Salon
...
2. **Hero** — Summertime Blooms! 🌸🌺🌼, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Brush Nails"
