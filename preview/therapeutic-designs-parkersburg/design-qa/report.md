# Design QA — therapeutic-designs-parkersburg

**Result:** PASS

**Craft warnings:** 5 (see craft section)
...
- WARN: 10 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 10 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
