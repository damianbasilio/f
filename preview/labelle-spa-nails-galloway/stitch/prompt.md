# Stitch prompt — LaBelle Spa & Nails (labelle-spa-nails-galloway)

Use with: `npm run stitch:prompt -- labelle-spa-nails-galloway` then `npm run stitch:build -- labelle-spa-nails-galloway`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **LaBelle Spa & Nails**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/labellegallowaynj/
**Business:** LaBelle Spa & Nails
**Category:** Salon / spa / personal care
**Location:** 168 South New York Road, Galloway, NJ 08205
**Phone:** (609) 652-8300
**Email:** labellespa609@gmail.com
**Review score:** 4.9
**Page description:** 📣 TUYỂN THỢ NAIL 💅 Salon đang cần tìm thêm đồng đội: ✨ Thợ bột / TAP Gel/ UV GEL ✨ Có trách nhiệm, vui vẻ, sạch sẽ ✨ Môi trường làm việc thân thiện, khách sang ✨ Thu nhập tốt – tip cao 📍Inbox để biết thêm chi tiết hoặc gọi trực tiếp để trao đổi công việc nhé! 💖 📞609 652 8300
**Hours:** Closed now

**About / profile details:**
- **Hours:** Closed now
- **Address:** 168 S New York Rd, Galloway, NJ, United States, 08205

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
📣 TUYỂN THỢ NAIL 💅 Salon đang cần tìm thêm đồng đội: ✨ Thợ bột / TAP Gel/ UV GEL ✨ Có trách nhiệm, vui vẻ, sạch sẽ ✨ Môi trường làm việc thân thiện, khách sang ✨ Thu nhập tốt – tip cao 📍Inbox để biết thêm chi tiết hoặc gọi trực tiếp để trao đổi công việc nhé! 💖 📞609 652 8300
Hours: Closed now
Address: 168 S New York Rd, Galloway, NJ, United States, 08205
Phone: 609 652 8300
Email: labellespa609@gmail.com
...
1. 📣 TUYỂN THỢ NAIL 💅 Salon đang cần tìm thêm đồng đội: ✨ Thợ bột / TAP Gel/ UV GEL ✨ Có trách nhiệm, vui vẻ, sạch sẽ ✨ Môi trường làm việc thân thiện, khách sang ✨ Thu nhập tốt – tip cao 📍Inbox để biết thêm chi tiết hoặc gọi trực tiếp để trao đổi công việc nhé! 💖 📞609 652 8300
2. Our Salon offers a unique beauty and wellness journey tailored to your specific well-being needs.
...
Reading this as: a first homepage for LaBelle Spa & Nails in Galloway (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **mosaic-hero** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **LaBelle Spa & Nails** only — it must not resemble other local-business sites or AI templates.
...
**LaBelle Spa & Nails** is a Salon / spa / personal care in Galloway.
...
- **H1 (adapt closely):** LaBelle Spa & Nails — serving Galloway
- **Subhead:** 📣 TUYỂN THỢ NAIL 💅 Salon đang cần tìm thêm đồng đội: ✨ Thợ bột / TAP Gel/ UV GEL ✨ Có…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- Our Salon offers a unique beauty and wellness journey tailored to your specific well-being needs
- Cut & color
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Galloway), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — LaBelle Spa & Nails — serving Galloway, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with LaBelle Spa & Nails"
