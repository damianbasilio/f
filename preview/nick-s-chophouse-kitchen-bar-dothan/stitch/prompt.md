# Stitch prompt — Nick’s Chophouse Kitchen + Bar (nick-s-chophouse-kitchen-bar-dothan)

Use with: `npm run stitch:prompt -- nick-s-chophouse-kitchen-bar-dothan` then `npm run stitch:build -- nick-s-chophouse-kitchen-bar-dothan`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Nick’s Chophouse Kitchen + Bar**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Nicks-Chophouse-61577286997712/
**Business:** Nick’s Chophouse Kitchen + Bar
**Category:** Restaurant / food service
**Location:** 256 North Foster Street, Dothan, AL 36303
**Phone:** (334) 699-2120
**Email:** carrie.rickman1@gmail.com
**Review score:** 4.5
**Page description:** Nick’s Chophouse , Dothan. 5,637 likes · 142 talking about this · 380 were here. Another Great American Restaurant from Chef Nick Rickman! 2018 World Chef Champion!
...
- **Hours:** Closed now
- **Address:** 256 North Foster , Dothan, AL, United States, 36303

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Nick’s Chophouse , Dothan. 5,637 likes · 142 talking about this · 380 were here. Another Great American Restaurant from Chef Nick Rickman! 2018 World Chef Champion!
...
1. C H O P H O U S E ✨ FOODIES BRUNCH starts @ 10:30 🥂 Head downtown and join us on this beautiful Saturday 🌞 #nickschophousedothan #visitdothan #brunch #mimosatime #chophousefoodies
2. Nick’s Chophouse is in Dothan, AL, United States.
3. Another Great American Restaurant from Chef Nick Rickman! 2018 World Chef Champion! Hours: Wednesday thru Saturday- Open @ 5pm for Dinner Saturday Brunch- 10:30am thru 1pm
4. 256 North Foster , Dothan, AL, United States, Alabama
5. Takeout · Dine-in · Reservations
...
Reading this as: a first homepage for Nick’s Chophouse Kitchen + Bar in Dothan (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **cardless-flow** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Nick’s Chophouse Kitchen + Bar** only — it must not resemble other local-business sites or AI templates.
...
**Nick’s Chophouse Kitchen + Bar** is a Restaurant / food service in Dothan.
...
- **H1 (adapt closely):** Nick’s Chophouse Kitchen + Bar — Dothan's local favorite
- **Subhead:** Nick’s Chophouse , Dothan. 5,637 likes · 142 talking about this · 380 were here. Anothe…
...
- Hours: Wednesday thru Saturday- Open @ 5pm for Dinner Saturday Brunch- 10:30am thru 1pm
- Daily specials
- Catering & events
- Dine-in & takeout
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Restaurant / food service), name, location (Dothan), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Nick’s Chophouse Kitchen + Bar — Dothan's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Nick’s Chophouse Kitchen + Bar"
