# Stitch prompt — Fresh Fade Barbershop (fresh-fade-barbershop-nashville)

Use with: `npm run stitch:prompt -- fresh-fade-barbershop-nashville` then `npm run stitch:build -- fresh-fade-barbershop-nashville`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Fresh Fade Barbershop**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Fresh-Fade-Barbershop-61569357849220/
**Business:** Fresh Fade Barbershop
**Category:** Restaurant / food service
**Location:** 3715 Clarksville Pike, Nashville, TN 37218
**Phone:** (629) 277-7761
**Email:** Peterfarg90@gmail.com
**Review score:** 4.9
**Page description:** This is a public event, so your post will be visible to anyone on Facebook.
**Hours:** Open now

**About / profile details:**
- **Hours:** Open now
- **Address:** 3713 Clarksville pike , Nashville, TN, United States, 37218

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
This is a public event, so your post will be visible to anyone on Facebook.
Hours: Open now
Address: 3713 Clarksville pike , Nashville, TN, United States, 37218
Phone: 265.663 7265
Email: Peterfarg90@gmail.com
...
1. Fresh Fade Barbershop created an event.
2. 3713 Clarksville pike , Nashville, TN, United States, Tennessee
...
Reading this as: a first homepage for Fresh Fade Barbershop in Nashville (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **cinematic-bleed** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Fresh Fade Barbershop** only — it must not resemble other local-business sites or AI templates.
...
**Fresh Fade Barbershop** is a Restaurant / food service in Nashville.
...
**Hero direction:**
- **H1 (adapt closely):** Fresh Fade Barbershop — Nashville's local favorite
- **Subhead:** This is a public event, so your post will be visible to anyone on Facebook.
...
2. **Hero** — Fresh Fade Barbershop — Nashville's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Fresh Fade Barbershop"
