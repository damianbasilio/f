// Micro-interactions and smooth scroll
        ...
        if (form) {
            form.addEventListener('submit', (e) => {
                ...
                btn.innerHTML = 'PROCESSING_PROTOCOL...';
                btn.classList.add('opacity-50', 'pointer-events-none');
                
                setTimeout(() => {
                    btn.innerHTML = 'RECOVERY_INITIALIZED';
                    btn.classList.remove('caution-bg');
        ...
        window.addEventListener('scroll', () => {
            ...
            if (window.scrollY > 50) {
                header.classList.add('bg-surface/95', 'backdrop-blur-md');
            } else {
                header.classList.remove('bg-surface/95', 'backdrop-blur-md');
            }
        });
