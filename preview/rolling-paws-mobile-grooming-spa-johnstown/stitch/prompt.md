# Stitch prompt — Rolling Paws Mobile Grooming Spa (rolling-paws-mobile-grooming-spa-johnstown)

Use with: `npm run stitch:prompt -- rolling-paws-mobile-grooming-spa-johnstown` then `npm run stitch:build -- rolling-paws-mobile-grooming-spa-johnstown`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Rolling Paws Mobile Grooming Spa**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/RollingPawsMobileGrooming/
**Business:** Rolling Paws Mobile Grooming Spa
**Category:** Pet grooming / pet services
**Location:** 35 N Walnut St, Johnstown, United States
**Phone:** (570) 328-1018
**Email:** ChrisBaranowski27@gmail.com
**Review score:** 4.1
**Page description:** Rolling Paws, Wilkes-Barre. 2,409 likes · 168 talking about this · 117 were here. Mobile Grooming Spa For Dogs
**Hours:** Opening Soon

**About / profile details:**
- **Hours:** Opening Soon
- **Address:** 35 N Walnut St, Wilkes-Barre, PA, United States, 18702

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
Rolling Paws, Wilkes-Barre. 2,409 likes · 168 talking about this · 117 were here. Mobile Grooming Spa For Dogs
Hours: Opening Soon
Address: 35 N Walnut St, Wilkes-Barre, PA, United States, 18702
Phone: 265.663 7265
Email: ChrisBaranowski27@gmail.com
...
1. We have one HAPPY WINNER this week❤️🎉❤️ Congratulations Kiddo Enjoy Your Summer🌞
2. Thank you so much for making her day, not only is she excited for the dumpling but its glitter!!
3. Heather Petrosino-Walsh I am thrilled for her! Not only glitter pink my favorite color❤️🎉❤️
...
Reading this as: a first homepage for Rolling Paws Mobile Grooming Spa in Johnstown (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **boutique-window** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Rolling Paws Mobile Grooming Spa** only — it must not resemble other local-business sites or AI templates.
...
**Rolling Paws Mobile Grooming Spa** is a Pet grooming / pet services in Johnstown.
...
- **Subhead:** Rolling Paws, Wilkes-Barre. 2,409 likes · 168 talking about this · 117 were here. Mobil…
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Rolling Paws Mobile Grooming Spa"
