// Header transparency shift on scroll
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > 50) {
                ...
                nav.classList.add('bg-silk-ganache', 'shadow-sm');
            } else {
                nav.classList.add('bg-transparent');
                nav.classList.remove('bg-silk-ganache', 'shadow-sm');
            }
        });

        // Simple form validation UI simulation
        ...
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                ...
                btn.classList.add('bg-tertiary-fixed-dim');
                form.reset();
                setTimeout(() => {
                    btn.innerText = originalText;
                    btn.classList.remove('bg-tertiary-fixed-dim');
                    btn.disabled = false;
                }, 3000);
            }, 1500);
        });
