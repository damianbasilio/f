# Stitch prompt — The Mobile Pet Spa (the-mobile-pet-spa-johnstown)

Use with: `npm run stitch:prompt -- the-mobile-pet-spa-johnstown` then `npm run stitch:build -- the-mobile-pet-spa-johnstown`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **The Mobile Pet Spa**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/The-Mobile-Pet-Spa-100054205134257/
**Business:** The Mobile Pet Spa
**Category:** Pet grooming / pet services
**Location:** 132 Stewart Run Rd, Johnstown, United States
**Phone:** (724) 422-6567
**Email:** themobilepetspa@yahoo.com
**Review score:** 4.3
**Page description:** The Mobile Pet Spa, Indiana. 513 likes · 1 talking about this · 6 were here. Mobile Pet Grooming services in Indiana and Cambria County...We come to you
**Hours:** Opening Soon

**About / profile details:**
- **Hours:** Opening Soon
- **Address:** 132 Stewart Run Rd, Indiana, PA, United States, 15701

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
The Mobile Pet Spa, Indiana. 513 likes · 1 talking about this · 6 were here. Mobile Pet Grooming services in Indiana and Cambria County...We come to you
Hours: Opening Soon
Address: 132 Stewart Run Rd, Indiana, PA, United States, 15701
Phone: 265.663 7265
Email: themobilepetspa@yahoo.com
...
1. Don't forget to vote every day through April 29th at 5pm. Go to "Services" Then Pet Grooming Then The Mobile Pet spa. Thank you for your vote!!!
2. Wed , April 19th at 5 pm is the last time to vote...Keep on voting!!!!
3. Mobile Pet Grooming services in Indiana and Cambria County...We come to you
4. Home - Best of Indiana County Contest
5. Support your favorite local companies by nominating them for an award in the Best of Indiana County contest! Learn more here.
...
Reading this as: a first homepage for The Mobile Pet Spa in Johnstown (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **split-editorial** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **The Mobile Pet Spa** only — it must not resemble other local-business sites or AI templates.
...
**The Mobile Pet Spa** is a Pet grooming / pet services in Johnstown.
...
- **H1 (adapt closely):** Professional pet care in Johnstown
- **Subhead:** The Mobile Pet Spa, Indiana. 513 likes · 1 talking about this · 6 were here. Mobile Pet…
- **Primary CTA:** Book grooming
- **Secondary CTA:** Call us

**Services / offerings (feature prominently with business-specific language):**
- Go to "Services" Then Pet Grooming Then The Mobile Pet spa
- Mobile Pet Grooming services in Indiana and Cambria County
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Pet grooming / pet services), name, location (Johnstown), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Professional pet care in Johnstown, subhead, Book grooming, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with The Mobile Pet Spa"
