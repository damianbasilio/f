# Stitch prompt — Leah's Place (leah-s-place-mobile)

Use with: `npm run stitch:prompt -- leah-s-place-mobile` then `npm run stitch:build -- leah-s-place-mobile`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Leah's Place**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/SpringhillSpa/
**Business:** Leah's Place
**Category:** Salon / spa / personal care
**Location:** 156-C North McGregor Avenue, Mobile, AL 36608
**Phone:** (251) 721-0343
**Email:** jeffreysleah@gmail.com
**Review score:** 5
**Page description:** Thanks for your support! For your mother or for yourself! We all deserve some pampering! squaremktg.com/campaigns/qudrFavDXhvyyTUG/landing Gift Cards
**Hours:** Closed now
...
1. Thanks for your support! For your mother or for yourself! We all deserve some pampering! squaremktg.com/campaigns/qudrFavDXhvyyTUG/landing Gift Cards
2. Click here for a free $5.00 coupon at Leah's Place!
3. By Appointment Only: Customized Skin Care and Waxing Services Spray tans
...
Reading this as: a first homepage for Leah's Place in Mobile (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Leah's Place** only — it must not resemble other local-business sites or AI templates.
...
**Leah's Place** is a Salon / spa / personal care in Mobile.
...
**Hero direction:**
- **H1 (adapt closely):** Click here for a free $5.00 coupon at Leah's Place
- **Subhead:** Thanks for your support! For your mother or for yourself! We all deserve some pampering…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- By Appointment Only: Customized Skin Care and Waxing Services Spray tans
- Cut & color
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Mobile), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — Click here for a free $5.00 coupon at Leah's Place, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Leah's Place"
