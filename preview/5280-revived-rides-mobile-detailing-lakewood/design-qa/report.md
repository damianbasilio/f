# Design QA — 5280-revived-rides-mobile-detailing-lakewood
...
- WARN: 18 uppercase-tracked labels — cap ~1 eyebrow per 3 sections
...
- WARN: 18 uppercase-tracked labels (eyebrow cap ~1 per 3 sections)
