# Stitch prompt — Holly's Pooch Pawlor (holly-s-pooch-pawlor-florence)

Use with: `npm run stitch:prompt -- holly-s-pooch-pawlor-florence` then `npm run stitch:build -- holly-s-pooch-pawlor-florence`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Holly's Pooch Pawlor**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/HollysPoochPawlor
**Business:** Holly's Pooch Pawlor
**Category:** Pet grooming / pet services
**Location:** Florence, United States
**Phone:** (843) 495-8769
**Email:** info@somotrash.com
**Review score:** 5
**Page description:** Full service MOBILE pet grooming business serving Florence, Hartsville, and Darlington areas.
...
Full service MOBILE pet grooming business serving Florence, Hartsville, and Darlington areas.
Phone: 843-307-3413
Email: info@somotrash.com

Recent posts from their Facebook page:
1. Sign up today! info@somotrash.com
2. Full service MOBILE pet grooming business serving Florence, Hartsville, and Darlington areas.
3. Florence, SC · Hartsville, SC · Darlington, SC
...
Reading this as: a first homepage for Holly's Pooch Pawlor in Florence (Pet grooming / pet services), Friendly, caring, trustworthy — pets are family tone, **boutique-window** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Holly's Pooch Pawlor** only — it must not resemble other local-business sites or AI templates.
...
**Holly's Pooch Pawlor** is a Pet grooming / pet services in Florence.
...
- **Subhead:** Full service MOBILE pet grooming business serving Florence, Hartsville, and Darlington …
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Holly's Pooch Pawlor"
