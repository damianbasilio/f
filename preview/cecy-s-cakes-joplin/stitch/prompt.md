# Stitch prompt — Cecy's Cakes (cecy-s-cakes-joplin)

Use with: `npm run stitch:prompt -- cecy-s-cakes-joplin` then `npm run stitch:build -- cecy-s-cakes-joplin`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Cecy's Cakes**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/11ceci2271/
**Business:** Cecy's Cakes
**Category:** Restaurant / food service
**Location:** 116 North Rangeline Road, Joplin, MO 64801
**Phone:** (417) 529-9422
**Email:** cecyvilla71@gmail.com
**Review score:** 4.1
...
- **Hours:** Closed now
- **Address:** 116 N Rangeline rd. suite 105, Joplin, MO, United States, 64801
...
Reading this as: a first homepage for Cecy's Cakes in Joplin (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Cecy's Cakes** only — it must not resemble other local-business sites or AI templates.
...
**Cecy's Cakes** is a Restaurant / food service in Joplin.
...
- **H1 (adapt closely):** Cecy's Cakes — Joplin's local favorite
- **Subhead:** Restaurant / food service — Joplin
...
2. **Hero** — Cecy's Cakes — Joplin's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Cecy's Cakes"
