# Stitch prompt — Essential Sweets (essential-sweets-jacksonville)

Use with: `npm run stitch:prompt -- essential-sweets-jacksonville` then `npm run stitch:build -- essential-sweets-jacksonville`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Essential Sweets**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/p/Essential-Sweets-100064656747152/
**Business:** Essential Sweets
**Category:** Restaurant / food service
**Location:** 2405 North Marine Boulevard, Jacksonville, NC 28546
**Phone:** (910) 939-3456
**Email:** essentialsweetscakeshop@gmail.com
**Review score:** 4.7
**Page description:** We are Essential Sweets, Family Owned and Operated! A bakery that specializes in Cheesecakes, Custom Cakes, Wedding Cakes, Cupcakes, and Cookie Decorating, as well as many other Baked goods all baked fresh daily.
**Hours:** Closed now
...
Reading this as: a first homepage for Essential Sweets in Jacksonville (Restaurant / food service), Warm, appetizing, neighborhood favorite — invite hunger and comfort tone, **diagonal-cut** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Essential Sweets** only — it must not resemble other local-business sites or AI templates.
...
**Essential Sweets** is a Restaurant / food service in Jacksonville.
...
**Hero direction:**
- **H1 (adapt closely):** Essential Sweets — Jacksonville's local favorite
- **Subhead:** We are Essential Sweets, Family Owned and Operated! A bakery that specializes in Cheese…
...
2. **Hero** — Essential Sweets — Jacksonville's local favorite, subhead, View menu & call, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Essential Sweets"
