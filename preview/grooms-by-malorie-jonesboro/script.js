// Smooth scroll implementation
        ...
        form.addEventListener('submit', (e) => {
            ...
            setTimeout(() => {
                btn.innerText = "Inquiry Sent. We'll reach out soon.";
                btn.classList.replace('bg-surface', 'bg-tertiary-fixed-dim');
                form.reset();
                setTimeout(() => {
                    btn.innerText = originalText;
                    btn.disabled = false;
                    btn.classList.replace('bg-tertiary-fixed-dim', 'bg-surface');
                }, 3000);
            }, 1500);
        });
