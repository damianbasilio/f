# Stitch prompt — Roadrunner Home and Pet Sitting Services (roadrunner-home-and-pet-sitting-services-chaparral)

Use with: `npm run stitch:prompt -- roadrunner-home-and-pet-sitting-services-chaparral` then `npm run stitch:build -- roadrunner-home-and-pet-sitting-services-chaparral`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Roadrunner Home and Pet Sitting Services**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/roadrunnerservices/
**Business:** Roadrunner Home and Pet Sitting Services
**Category:** Local business
**Location:** Las Cruces, Chaparral, United States
**Phone:** (575) 639-4007
**Email:** Daleandlaura@roadrunnerhome.com
**Review score:** 5
**Page description:** “We ask them to live in our world, follow our rules, and speak our language. But today, let’s try to speak theirs. Let the sniff be a little longer, the grass be a little rolling-er, and the ‘dog’ be a little louder. They do so much to fit into our lives—the least we can do is let them be themselves. 🐾” #dog #dogmom #puglife #petlovers #pugsofinstagram
**Hours:** Always open

**About / profile details:**
- **Hours:** Always open
- **Address:** Las Cruces, NM, United States, 88011

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
“We ask them to live in our world, follow our rules, and speak our language. But today, let’s try to speak theirs. Let the sniff be a little longer, the grass be a little rolling-er, and the ‘dog’ be a little louder. They do so much to fit into our lives—the least we can do is let them be themselves. 🐾” #dog #dogmom #puglife #petlovers #pugsofinstagram
Hours: Always open
Address: Las Cruces, NM, United States, 88011
Phone: 575-639-4007
Email: Daleandlaura@roadrunnerhome.com
...
1. “We ask them to live in our world, follow our rules, and speak our language. But today, let’s try to speak theirs. Let the sniff be a little longer, the grass be a little rolling-er, and the ‘dog’ be a little louder. They do so much to fit into our lives—the least we can do is let them be themselves. 🐾” #dog #dogmom #puglife #petlovers #pugsofinstagram
2. Pet Sitting and Care House Sitting Errands and More Professional, trustworthy care Insured and Bonded
3. Las Cruces, NM, United States, New Mexico
4. It'll be available to watch on Yashi Gupta's profile shortly.
...
Reading this as: a first homepage for Roadrunner Home and Pet Sitting Services in Chaparral (Local business), Professional, welcoming, community-rooted tone, **asymmetric-overlap** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Roadrunner Home and Pet Sitting Services** only — it must not resemble other local-business sites or AI templates.
...
**Roadrunner Home and Pet Sitting Services** is a Local business in Chaparral.
...
- **H1 (adapt closely):** Roadrunner Home and Pet Sitting Services — serving Chaparral
- **Subhead:** “We ask them to live in our world, follow our rules, and speak our language. But today,…
...
2. **Hero** — Roadrunner Home and Pet Sitting Services — serving Chaparral, subhead, Contact us, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Roadrunner Home and Pet Sitting Services"
