# Stitch prompt — Remares Towing & Recovery (remares-towing-recovery-campton)

Use with: `npm run stitch:prompt -- remares-towing-recovery-campton` then `npm run stitch:build -- remares-towing-recovery-campton`

---

## Prompt (paste into Stitch)

You are an award-winning local-brand web designer building **one bespoke homepage** for **Remares Towing & Recovery**. This business has **no dedicated website** — only a Facebook page. You are not filling a template. You are designing a **unique, premium, memorable first impression** that could only belong to this business.
...
**Page:** https://www.facebook.com/RemaresTowingandRecovery/
**Business:** Remares Towing & Recovery
**Category:** Salon / spa / personal care
**Location:** 109 black hall rd, Campton, United States
**Phone:** (603) 988-1501
**Email:** remarestowing@gmail.com
**Review score:** 4.5
**Page description:** We are ready for snow! Are you? 📞(603)988-1501📞 is the number to call if your in need of snow removal this coming storm!
**Hours:** Always open

**About / profile details:**
- **Hours:** Always open
- **Address:** 109 black hall rd , Epsom, NH, United States, 03234

**Full scraped profile (About, services, voice — use for copy, do not invent facts):**
We are ready for snow! Are you? 📞(603)988-1501📞 is the number to call if your in need of snow removal this coming storm!
Hours: Always open
Address: 109 black hall rd , Epsom, NH, United States, 03234
Phone: 265.663 7265
Email: remarestowing@gmail.com
...
1. We are ready for snow! Are you? 📞(603)988-1501📞 is the number to call if your in need of snow removal this coming storm!
2. -Towing/Recovery 24/7 -Equipment Transportation -Roadside Assist
3. Remare's Towing & Recovery's Photo
...
Reading this as: a first homepage for Remares Towing & Recovery in Campton (Salon / spa / personal care), Polished, relaxing, appointment-ready tone, **cinematic-bleed** archetype — must feel like a one-off commission, not a reused template.

### Uniqueness mandate
- This homepage is for **Remares Towing & Recovery** only — it must not resemble other local-business sites or AI templates.
...
**Remares Towing & Recovery** is a Salon / spa / personal care in Campton.
...
- **H1 (adapt closely):** -Towing/Recovery 24/7 -Equipment Transportation -Roadside Assist
- **Subhead:** We are ready for snow! Are you? 📞(603)988-1501📞 is the number to call if your in need…
- **Primary CTA:** Book appointment
- **Secondary CTA:** View services

**Services / offerings (feature prominently with business-specific language):**
- -Towing/Recovery 24/7 -Equipment Transportation -Roadside Assist
- Remare's Towing & Recovery's Photo
- Cut & color
...
There is **no existing website** and **nothing to extract**. Choose palette and typography from business type (Salon / spa / personal care), name, location (Campton), and post voice. Document colors as CSS custom properties in `styles.css`.
...
2. **Hero** — -Towing/Recovery 24/7 -Equipment Transportation -Roadside Assist, subhead, Book appointment, your invented palette dominant
...
- Mockup banner placeholder at top: "Concept preview — not affiliated with Remares Towing & Recovery"
